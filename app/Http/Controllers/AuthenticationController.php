...
class AuthenticationController extends Controller
{
    ...
    public function showdashboard()
    {
        ...
        $totallab = Doctors::where('profile_type','3')->count();
        ...
        return view("admin.dashboard")->with("months", $months)->with("earnings", $earnings)->with("pharmacy", $pharmacy)->with("totaldoctor", $totaldoctor)->with("totalpharmacy", $totalpharmacy)->with("totalpharmacyorder", $totalpharmacyorder)->with("totalappointment", $totalappointment)->with("totalreview", $totalreview)->with("totalpatient", $totalpatient)->with("totalhospital", $totalhospital)->with("totallab", $totallab);
    }
