...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ Request::is('backend/patients') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/patients') }}">
                    <i class="fas fa-users fa-palette"></i>
                    <span>{{ __('message.Patients') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/services') ? 'active' : '' }}">
            ...
            <li class="nav-item {{ Request::is('backend/pharmacy') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/pharmacy') }}">
                    <i class="fas fa-clinic-medical"></i>
                    <span>{{ __('message.Pharmacy') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/pharmacyorder') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/pharmacyorder') }}">
                    <i class="fab fa-jedi-order"></i>
                    <span>{{ __('message.Pharmacy Order') }}</span>
                </a>
            </li>
             <li class="nav-item {{ Request::is('backend/medicines') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/medicines') }}">
            ...
            <li class="nav-item {{ Request::is('backend/laboratory') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/laboratory') }}">
                 <i class="fas fa-flask"></i>
                    <span>{{ __('message.Laboratory') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/laboratoryorder') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/laboratoryorder') }}">
                 <i class="fas fa-flask"></i>
            ...
            <li class="nav-item {{ Request::is('backend/city') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/city') }}">
                    <i class="fas fa-fw fa-pills"></i>
                    <span>{{ __('message.city') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/banner') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/banner') }}">
                    <i class="fas fa-fw fa-image"></i>
                    <span>{{ __('message.banner') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/reviews') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/reviews') }}">
                    <i class="fas fa-fw fa-star"></i>
                    <span>{{ __('message.Review') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/complain') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/complain') }}">
                    <i class="fas fa-fw fa-palette"></i>
                    <span>{{ __('message.complain') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/contact_list') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/contact_list') }}">
                    <i class="fas fa-file-contract"></i>
                    <span>{{ __('message.Contact') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/news') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/news') }}">
                    <i class="fas fa-fw fa-palette"></i>
                    <span>{{ __('message.News') }}</span>
                </a>
            </li>
           
            <li class="nav-item {{ Request::is('backend/languages/en') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/languages/en') }}">
            ...
            <li class="nav-item {{ Request::is('backend/about') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/about') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>{{ __('message.About') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/Terms_condition') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/Terms_condition') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>{{ __('message.term') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/app_privacy') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/app_privacy') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>{{ __('message.Privecy') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/data_deletion') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/data_deletion') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
            ...
            <li class="nav-item {{ Request::is('backend/doctor_report') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('doctor_report') }}">
                    <i class="fas fa-address-book"></i>
                    <span>{{ __('message.Doctors') }} </span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/user_report') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('user_report') }}">
                    <i class="fas fa-address-book"></i>
                    <span>{{ __('message.Patients') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/do_sub_report') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('do_sub_report') }}">
                    <i class="fas fa-address-book"></i>
                    <span>{{ __('message.Doctor Subscription') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/app_book_report') ? 'active' : '' }}">
            ...
            <li class="nav-item {{ Request::is('backend/pending_payment') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/pending_payment') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
            ...
            <li class="nav-item {{ Request::is('backend/subscriber_doc') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/subscriber_doc') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>{{ __('message.Subscriber') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/complete_payment') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/complete_payment') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
            ...
            <li class="nav-item {{ Request::is('backend/sendnotification') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/sendnotification') }}">
                    <i class="fab fa-snapchat-ghost"></i>
                    <span>{{ __('message.Send Notification') }}</span>
                </a>
            </li>
            <li class="nav-item {{ Request::is('backend/notificationkey') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('backend/notificationkey') }}">
                    ...
                    <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                                ...
                                {{-- {{ Session::get('locale') ?? 'en' }}--}} {{$color->lang_code}} <i class="fas fa-angle-down ml-2"></i>
                            </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="{{ url('backend/editprofile') }}">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    {{ __('message.View Profile') }}
                                </a>
                                <a class="dropdown-item" href="{{ url('backend/setting') }}">
                                    <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                                    {{ __('message.Setting') }}
                                </a>
                                <a class="dropdown-item" href="{{ url('backend/changepassword') }}">
    ...
    <input type="hidden" id="siteurl" value="{{ url('backend') }}" />
