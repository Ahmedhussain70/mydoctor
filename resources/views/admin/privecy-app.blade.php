...
@section('title')
{{__("message.Privecy")}} | {{__("message.Admin Dashboard")}}
@stop
@section('meta-data')
@stop
@section('content')
                        ...
                        <div class="modal-content">
                          <div class="row m-3">
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-1">
                                <a href= "{{url('Privacy-Policy')}}" class="btn btn-md btn-primary"
                                    value="Visit" target="#">{{ __('message.Visit') }}</a>
                            </div>
                        </div>
                          <div class="modal-body">
                            <form action="{{url('backend/edit_app_privacy')}}" method="post" enctype="multipart/form-data">
                              {{csrf_field()}}
