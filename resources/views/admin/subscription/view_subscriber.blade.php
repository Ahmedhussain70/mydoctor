               ...
               <div class="page-title-box d-flex align-items-center justify-content-between">
                  ...
                  <div class="page-title-right">
                     <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('backend/subscriber_doc')}}">{{__("message.Subscription")}}</a></li>
                                   ...
                                   <?php
                                        if(isset($data->deposit_image))
                                        {
                                           ...
                                           ?>
                                            ...
                                            <a href="<?php echo $destinationPath; ?>"  target="_blank">{{__("message.Show Receipt")}}</a>
                                           <?php
                                        }else{
                                            echo "-";
                                        }
