    ...
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1>{{ __('message.Search Hospital') }}</h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <div class="auto-container">
                <ul class="bread-crumb clearfix">
                    ...
                    <li>{{ __('message.Search Hospital') }}</li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="auto-container">
            <div class="content-box">
                <div class="form-inner clearfix">
                    <form action="{{ url('searchhospital') }}" method="get">
                        <div class="form-group clearfix">

                            <input type="text" name="term" value="{{ $term }}" id="term"
                                placeholder="Ex. {{ __('message.Hospital') }} {{ __('message.Name') }}" required="">
                                    ...
                                    <div class="inner-box">
                                        ...
                                        <div class="content-box">
                                            ...
                                            <div class="rating-box clearfix">
                                                ...
                                                <div class="link"><a
                                                        href="{{ url('viewhospital') . '/' . $dl->id }}">{{ $dl->working_time }}</a>
                                                </div>
                                            </div>
...
@section('footer')
    <script type="text/javascript">
        function serachcity(val) {
            ...
            if (term === "") {
                if (val !== "") {
                    window.location.href = '{{ url('searchhospital') }}' + '?city_id=' + val;
                }
            } else {

                window.location.href = '{{ url('searchhospital') }}' + '?city_id=' + val + '&term=' + term;
