...
@section('content')
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-6 category-block">
                        <div class="category-block-one wow fadeInUp animated animated animated" data-wow-delay="00ms"
                            ...
                            <div class="inner-box">
                                ...
                                <h3> {{$currency[1]}} {{ $subscription->price }}/{{ $subscription->month }} {{ __('message.month') }}</h3>
                                <ul class="features">
                                    <li><i class="fas fa-check-circle"></i> {{ __('message.sub_plan_test_1') }}</li>
                                    <li><i class="fas fa-check-circle"></i> {{ __('message.sub_plan_test_2') }}</li>
                                    <li><i class="fas fa-check-circle"></i> {{ __('message.sub_plan_test_3') }}</li>
                                </ul>
                                ...
                                <div class="btn-box"><a href="#" data-toggle="modal" data-target="#add_plan"
                                        ...
                                        class="theme-btn-one">{{ __('message.purchase plan') }}<i class="icon-Arrow-Right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="row mx-1">
                        ...
                        <div class="col-6">
                            ...
                            <p><b>{{$currency[1]}} </b><b id="pland"></b></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="choose-service">
                                        ...
                                        <div class="custom-controls-stacked">
                                            <label class="custom-control material-checkbox">
                                                <input type="radio" class="material-control-input" name="payment_type"
                                                    ...
                                                    onchange="changeform(this.value)">
                                                <span class="material-control-indicator"></span>
                                                <span class="description">{{ __('message.Uploaded Receipt') }}</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="uploaded_receipt_div" style="display: none;">
                                    <form action="{{ url('doctor_add_plan') }}" method="POST"
    ...
    <script>
        ...
        function get_plan_id(id, price, month) {
            ...
            $("#pland").text( price + "/" + month + " {{ __('message.month') }}");
