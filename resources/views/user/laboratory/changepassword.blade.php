      ...
      <div class="profile-box">
         ...
         <div class="profile-info">
            <ul class="list clearfix">
                ...
                <li><a href="{{ url('laboratoryreport') }}"><i class="fas fa-pills"></i>{{ __('message.Report') }}</a></li>
                ...
                <li><a href="{{url('laboratorychangepassword')}}"  class="current"><i class="fas fa-unlock-alt"></i>{{__('message.Change Password')}}</a></li>
