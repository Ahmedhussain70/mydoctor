@extends('user.layout')
@section('title')
    {{ __('message.Laboratory') }} {{ __('message.Dashboard') }}
@stop
@section('meta-data')
    ...
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1>{{ __('message.Laboratory') }} {{ __('message.Dashboard') }}</h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <ul class="bread-crumb clearfix">
                ...
                <li>{{ __('message.Laboratory') }} {{ __('message.Dashboard') }}</li>
            </ul>
        </div>
    </section>
            ...
            <div class="profile-box">
                ...
                <div class="profile-info">
                    <ul class="list clearfix">
                        <li><a href="{{ url('laboratorydashboard') }}" class="current"><i
                                    class="fas fa-columns"></i>{{ __('message.Dashboard') }}</a></li>
                        <li><a href="{{ url('laboratoryreport') }}"><i
