      ...
      <div class="profile-box">
         <div class="upper-box">
            <figure class="profile-image">
               ...
               @else
               <img src="{{asset('public/upload/doctors/defaultlaboratory.png')}}" alt="">
               @endif
            </figure>
         ...
         <div class="profile-info">
            <ul class="list clearfix">
                <li><a href="{{url('laboratorydashboard')}}" ><i class="fas fa-columns"></i>{{__('message.Dashboard')}}</a></li>
                <li><a href="{{ url('laboratoryreport') }}"><i class="fas fa-pills"></i>{{ __('message.Reports') }}</a></li>
                <li><a href="{{url('laboratoryreview')}}" ><i class="fas fa-star"></i>{{__('message.Reviews')}}</a></li>
                <li><a href="{{url('laboratoryeditprofile')}}" class="current"><i class="fas fa-user"></i>{{__('message.My Profile')}}</a></li>
                <li><a href="{{url('laboratorychangepassword')}}"><i class="fas fa-unlock-alt"></i>{{__('message.Change Password')}}</a></li>
            ...
            <div class="add-listing my-profile">
               <div class="single-box">
                  ...
                  <div class="inner-box">
                     ...
                     @endif
                     <form action="{{url('updatelaboratory')}}" method="post" enctype="multipart/form-data">
                       {{csrf_field()}}
                                    <div class="profile-title">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                ...
                                                <input type="text" name="name" id="name" placeholder="{{__('message.Enter Laboratory Name')}}" required="" value="{{isset($doctordata->name)?$doctordata->name:''}}">
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                ...
                                                <textarea name="aboutus" id="aboutus" placeholder="{{__('message.Enter About Laboratory')}}" required="">{{isset($doctordata->aboutus)?$doctordata->aboutus:''}}</textarea>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
