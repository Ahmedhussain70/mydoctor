...
@section('content')
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1 id="aa">{{ __('message.Laboratory Login') }}</h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <div class="auto-container">
                <ul class="bread-crumb clearfix">
                    ...
                    <li id="aa1">{{ __('message.Laboratory Login') }}</li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="auto-container">
            <div class="inner-box">
                <div class="content-box">
                    <div class="title-box">
                        <h3 id="aa2">{{ __('message.Laboratory Login') }}</h3>
                        <a href="{{ url('laboratoryregister') }}">{{ __('message.Profile Register') }}</a>
                    </div>
                    <div class="inner">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                             ...
                             <div class="tab-pane fade" id="pills-laboratory" role="tabpanel"
                                ...
                                <form action="{{ url('postloginlaboratory') }}" method="post" class="registration-form">
                                    {{ csrf_field() }}
                                    <div class="row clearfix">

                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                            <label class="fr">{{ __('message.Email') }}</label>
                                            <input type="email" name="email" id="lab_email"
                                                placeholder="{{ __('message.Your email') }}" required=""
                                                value="{{ isset($_COOKIE['lab_email']) ? $_COOKIE['lab_email'] : '' }}">
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                            <label class="fr">{{ __('message.Password') }}</label>
                                            <input type="password" name="password" id="lab_password"
                                                placeholder="{{ __('message.Enter password') }}" required=""
                                                value="{{ isset($_COOKIE['lab_password']) ? $_COOKIE['lab_password'] : '' }}">
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                            <div class="custom-check-box fr">
                                                <div class="custom-controls-stacked">
                                                    <label class="custom-control material-checkbox">
                                                        @if (isset($_COOKIE['lab_rem_me']))
                                                            <input type="checkbox" class="material-control-input"
                                                                value="1" name="rem_me" id="lab_rem_me"
                                                                checked="">
                                                        @else
                                                            <input type="checkbox" class="material-control-input"
                                                                value="1" name="rem_me" id="lab_rem_me">
    ...
    <script>
        ...
        document.getElementById("pills-profile-tab").addEventListener("click", handleClick);
         document.getElementById("pills-labratory-tab").addEventListener("click", handleClick);
    </script>
    <script>
    document.addEventListener("DOMContentLoaded", function () {
        var tabToActivate = document.getElementById("login-error-tab")?.value;
        if (tabToActivate === "laboratory") {
            // Bootstrap 5 tab activation
            var tabTriggerEl = document.querySelector('#pills-laboratory-tab');
            if (tabTriggerEl) {
