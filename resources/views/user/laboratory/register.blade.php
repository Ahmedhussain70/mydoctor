@extends('user.layout')
@section('title')
 {{__('message.Laboratory Register')}}
 {{-- {{ __('Laboratory Register') }} --}}
@stop
@section('meta-data')
...
<section class="page-title-two">
            <div class="title-box centred bg-color-2">
                ...
                <div class="auto-container">
                    <div class="title">
                        <h1 id="aa">{{__('message.Laboratory Register')}}</h1>
                    </div>
                </div>
            </div>
            <div class="lower-content">
                <div class="auto-container">
                    <ul class="bread-crumb clearfix">
                        ...
                        <li id="aa1">{{__('message.Laboratory Register')}}</li>
                    </ul>
                </div>
            </div>
</section>
            ...
            <div class="auto-container">
                <div class="inner-box">
                    <div class="content-box">
                        <div class="title-box">
                            <h3 id="aa2">{{__('message.Laboratory Register')}}</h3>
                            <a href="{{url('laboratorylogin')}}">{{__("message.Already a Profile?")}}</a>
                        </div>
                        <div class="inner">
                            ...
                            {{-- <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link"  id="pills-home-tab" data-toggle="pill" href="#pills-home"
                                        ...
                                        aria-selected="false">{{ __('message.Doctors') }}</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-laboratory-tab" data-toggle="pill" href="#pills-laboratory"
                                        role="tab" aria-controls="pills-laboratory"
                                        aria-selected="true">{{ __('message.Laboratory') }}</a>
                             ...
                             <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('doctorregister') ? 'active' : '' }}"
                                    href="{{ url('doctorregister') }}">
                                        {{ __('message.Doctors') }}
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('pharmacyregister') ? 'active' : '' }}"
                                    href="{{ url('#') }}">
                                        {{ __('message.Pharmacy') }}
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Request::is('laboratoryregister') ? 'active' : '' }}"
                                    href="{{ url('laboratoryregister') }}">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="pills-laboratory" role="tabpanel"
                                    aria-labelledby="pills-laboratory-tab">
                                    <form action="{{url('postlaboratoryregister')}}" method="post" class="registration-form">
                                        {{csrf_field()}}
                                         <div class="row clearfix">
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                <label class="fr" >{{__('message.Name')}}</label>
                            ...
                            {{-- <div class="text"><span>{{__('message.or')}}</span></div>div class="tab-content" id="pills-tabContent"> --}}
