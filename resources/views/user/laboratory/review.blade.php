...
<section class="page-title-two">
   <div class="title-box centred bg-color-2">
      ...
      <div class="auto-container">
         <div class="title">
            <h1>{{__('message.Laboratory Reviews')}}</h1>
         </div>
      </div>
   </div>
   <div class="lower-content">
      <ul class="bread-crumb clearfix">
         ...
         <li>{{__('message.Laboratory Reviews')}}</li>
      </ul>
   </div>
</section>
      ...
      <div class="profile-box">
         ...
         <div class="profile-info">
            <ul class="list clearfix">
                ...
                <li><a href="{{url('laboratoryreview')}}" class="current"><i class="fas fa-star"></i>{{__('message.Reviews')}}</a></li>
                <li><a href="{{url('laboratoryeditprofile')}}"><i class="fas fa-user"></i>{{__('message.My Profile')}}</a></li>
                           ...
                           <div class="inner-box">
                              <figure class="image-box">
                                 @if($uf->patientls->profile_pic!="")
                                       <img src="{{asset('public/upload/profile').'/'.$uf->patientls->profile_pic}}" alt=""  style="max-height: 300px; min-height: 300px;">
                                 @else
                                        <img src="{{asset('public/upload/profile/profile.png')}}" alt=""  style="max-height: 300px; min-height: 300px;">
                                 @endif
                              </figure>
                              <div class="lower-content">
                                 <ul class="name-box clearfix">
                                    <li class="name">
                                       <h3><a href="{{url('viewlaboratory').'/'.$uf->doc_id}}">{{substr($uf->patientls->name,0,10)}}</a></h3>
                                    </li>
