...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/front_pro/assets/css/font-awesome-all.css') }}">
    ...
    <script type="text/javascript"
        src='https://maps.googleapis.com/maps/api/js?key={{ config('services.google.maps_key') }}&sensor=false&libraries=places'></script>
...
<body>
    ...
    `);
                    ...
                    $('#clearChat').click(function () {
                        $.post("{{ route('gemini.clear') }}", { _token: "{{ csrf_token() }}" }, function () {
                            $('#chatHistory').html(`
            <div id="defaultMessage" class="text-center">
