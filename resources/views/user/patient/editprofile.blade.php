      ...
      <div class="profile-box patient-profile">
         ...
         <div class="profile-info">
            <ul class="list clearfix">
                ...
                <li><a href="{{url('usermedicineorder')}}"><i class="fas fa-columns"></i>{{__('message.Medicine Order')}}</a></li>
                <li><a href="{{ url('userlabreportlist') }}"><i class="fas fa-columns"></i>{{ __('message.Laboratory Report') }}</a></li>
                     ...
                     <form action="{{url('updateuserprofile')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row clearfix">
                           ...
                           <div class="col-lg-12 col-md-6 col-sm-12 form-group">
                              ...
                              <input type="text" name="name" placeholder="{{__('message.Enter Your First Name')}}" required="" value="{{isset($userdata->name)?$userdata->name:''}}">
                           </div>
                           <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                              <label>{{__('message.Phone no')}}</label>
                              <input type="text" name="phone" placeholder="{{__('message.Enter Phone')}}" value="{{isset($userdata->phone)?$userdata->phone:''}}" required="">
                           </div>
                           <div class="col-lg-6 col-md-6 col-sm-12 form-group">
