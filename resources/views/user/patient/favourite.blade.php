            ...
            <div class="profile-box patient-profile">
                ...
                <div class="profile-info">
                    <ul class="list clearfix">
                        ...
                        <li><a href="{{ url('favouriteuser') }}" class="current"><i
                                            ...
                                            <div class="team-block-three">
                                                <div class="inner-box">
                                                    <figure class="image-box">
                                                        <img src="{{ asset('public/upload/doctors') . '/' . $uf->doctorls->image }}"
                                                            alt="">
                                                        <a href="javascript:userfavoritedashboard('{{ $uf->doctor_id }}')"
                                                    ...
                                                    <div class="lower-content">
                                                        <ul class="name-box clearfix">
                                                            <li class="name">
                                                                <h3><a
                                                                        href="{{ url('viewdoctor') . '/' . $uf->doctor_id }}">{{ substr($uf->doctorls->name, 0, 10) }}</a>
                                                                </h3>
                                                            </li>
                                                        ...
                                                        <span
                                                            class="designation">{{ $uf->doctorls->department_name }}</span>
                                                        <div class="rating-box clearfix">
                                                            <ul class="rating clearfix">
                                                                ...
                                                                <li><a
                                                                        href="">({{ $uf->doctorls->totalreview }})</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="location-box">
                                                            <p><i
                                                                    class="fas fa-map-marker-alt"></i>{{ substr($uf->doctorls->address, 0, 25) }}
                                                            </p>
                                                        </div>
                                                        <div class="lower-box clearfix">
                                                            <a
                                                                href="{{ url('viewdoctor') . '/' . $uf->doctor_id }}">{{ __('message.Book Now') }}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
