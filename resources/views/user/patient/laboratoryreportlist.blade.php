    ...
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1>{{ __('message.Laboratory Order') }}</h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <ul class="bread-crumb clearfix">
                ...
                <li>{{ __('message.Laboratory Order') }}</li>
            </ul>
        </div>
    </section>
            ...
            <div class="profile-box patient-profile">
                ...
                <div class="profile-info">
                    <ul class="list clearfix">
                        ...
                        <li><a href="{{ url('userlabreportlist') }}" class="current"><i
            ...
            <div class="content-container">
                <div class="outer-container">
                    ...
                    <div class="doctors-appointment">
                        <div class="title-box">
                            <h3>{{ __('message.Laboratory Order') }}</h3>
                        </div>
                            ...
                            <div class="table-outer">
                                <table class="" id="myTable">
                                    <thead class="table-header">
                                        <tr>
                                            <th>{{ __('message.Id') }}</th>
                                            <th>{{ __('message.Laboratory') }} {{ __('message.Name') }}</th>
            ...
            function get_reportdata(id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#m_data").append("<p style='text-align: " + (isRTL ? "right" : "left") + ";'><b>" +
                            "{{ __('message.Laboratory') }} {{ __('message.Name') }}" + ": </b>" +
                            orderDetails
                            .laboratory_id + "</p><hr>");
