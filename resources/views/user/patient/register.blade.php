                ...
                <div class="content-box">
                  ...
                  <div class="row clearfix">
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                        ...
                        <input type="password" name="password_confirmation" id="cpwd" onchange="checkbothpassword(this.value)" placeholder="{{__('message.Enter Confirm password')}}" required="" />
                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                        ...
                        <form action="{{ isset($patient) ? url('user/update/' . $patient->id) : url('userpostregister') }}"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    ...
                                    <input type="text" id="name" name="name"
                                        placeholder="{{ __('message.Your name') }}" required
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    ...
                                    <input type="text" name="phone" id="phone"
                                        placeholder="{{ __('message.Enter Your Phone number') }}" required
                                ...
                                @unless (isset($patient))
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        ...
                                        <input type="password" name="password_confirmation" id="cpwd"
                                            ...
                                            placeholder="{{ __('message.Enter Confirm password') }}" required />
                                        <span id="cpwd_error" style="color: red"></span>
                                            ...
                                            <div class="custom-controls-stacked">
                                                <label class="custom-control ">
                                                    ...
                                                    <span class="description">
                                                        {{ __('message.I accept') }}
                                                        <a href="{{ url('/') }}">{{ __('message.terms') }}</a>
                                                        {{ __('message.and') }}
                                                        <a href="{{ url('/') }}">{{ __('message.conditions') }}</a>
                                                        {{ __('message.and general policy') }}
                                                    </span>
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                    <button type="submit" class="theme-btn-one">
                                        {{ isset($patient) ? __('message.Update Profile') : __('message.Register Now') }}
                        ...
                        <div class="login-now">
                            <p>{{ __('message.Already have an account') }} <a
                                    href="{{ url('patientlogin') }}">{{ __('message.Login Now') }}</a></p>
                        </div>
                    </div>
                </div>
            </div>
