...
@section('content')
                    ...
                    <form action="{{ url('searchdoctor') }}" method="get">
                        <div class="form-group clearfix">
                            ...
                            <input type="text" name="term" value="{{ $term }}" id="term"
                                placeholder="{{ __('message.Ex. Name') }}" required="">
                            @if (!empty($type))
    ...
    <input type="text" id="city" value="{{ request()->get('city_id', '') }}">
@stop
@section('footer')
    <script type="text/javascript">
        function serachsep(val) {
            ...
            if (term === "") {
                if (val !== "") {
                    if (cityId !== "") {
                        window.location.href = '{{ url('searchdoctor') }}' + '?type=' + val + '&city_id=' + cityId;
                    } else {
                ...
                if (cityId !== "") {
                    window.location.href = '{{ url('searchdoctor') }}' + '?type=' + val + '&term=' + term + '&city_id=' +
                        cityId;
                } else {
        ...
        function serachcity(val) {
            ...
            if (term === "") {
                if (val !== "") {
                    if (type !== "") {
                        window.location.href = '{{ url('searchdoctor') }}' + '?city_id=' + val + '&type=' + type;
                    } else {
                        window.location.href = '{{ url('searchdoctor') }}' + '?city_id=' + val;
                    }
                }
            } else {
                if (type !== "") {
                    window.location.href = '{{ url('searchdoctor') }}' + '?city_id=' + val + '&term=' + term + '&type=' +
                        type;
                } else {
                    window.location.href = '{{ url('searchdoctor') }}' + '?city_id=' + val + '&term=' + term;
                }
            }
