                                ...
                                <div class="inner-box">
                                    <figure class="image-box">
                                        ...
                                        <div class="doctor-detail-page-main-box"
                                            style="background-image:url('{{ $path }}'); background-size: 311px 220px;">
                                        </div>
                                    </figure>
                                    <div class="content-box">
                                        ...
                                        <div class="like-box">
                                            @if ($data->is_fav == '0')
                                                @if (empty(Session::has('user_id')))
                                                    ...
                                                    @else
                                                        <a href="javascript:userfavorite('{{ $data->id }}')"
                                                            id="favdoc{{ $data->id }}">
                                                @endif
                                            @else
                                        ...
                                        <div class="lower-box clearfix">
                                            <ul class="info clearfix">
                                                <li><i
                                                        class="fas fa-map-marker-alt"></i>{{ substr($data->address, 0, 40) }}
                                                </li>
                                                <li><i class="fas fa-phone"></i><a
                                                        href="{{ $data->phoneno }}">{{ $data->phoneno }}</a></li>
                                            </ul>
                                            <div class="view-map"><a
                                                    href="https://maps.google.com/?q={{ $data->lat }},{{ $data->lon }}"
                                                    target="_blank">{{ __('message.View Map') }}</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <form action="{{ url('savereview') }}" method="post">
                                                    ...
                                                    <div class="row clearfix">
                                                        ...
                                                        @if (Session::has('user_id') && Session::get('role_id') == '1')
                                                            <button
                                                                class="theme-btn-one">{{ __('message.Submit Review') }}<i
                                                                    class="icon-Arrow-Right"></i></button>
                                                        @else
                                                            <a href="{{ url('patientlogin') }}"
                                                                class="theme-btn-one">{{ __('message.Submit Review') }}</a>
                                                        @endif
                            ...
                            <div class="form-widget">
                                ...
                                <div class="form-inner">
                                    <div class="appointment-time">
                                        ...
                                        <p>{{ __('message.consultation_fees') }} : {{ $currency[1] }}<span
                                                id="consultation_fees">{{ $data->consultation_fees }}</span></p>
                                        <input type="hidden" name="doctor_id" id="doctor_id"
                                            value="{{ $data->id }}">
                                        <input type="hidden" name="consultation_fees"
                                            value="{{ $data->consultation_fees }}">
                                        <div class="form-group">
                                            <input type="text" name="date" id="date"
                                                value="{{ date('m/d/Y') }}" id="datepicker"
                                            ...
                                            <div class="custom-dropdown" id="timerange"
                                                ...
                                                <select class="" name="slottime" id="slottime" required=""
                                                    ...
                                                    @foreach ($schedule as $s)
                                                        <option value="{{ $s['id'] }}" data-display-text="Fruits">
                                                            {{ $s['title'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="custom-slot-design-box">
                                            ...
                                            @else
                                                <p style="color: red;margin-left: 10px;">
                                                    {{ __('message.Doctor isnot Avilable') }}</p>
                                            @endif
                                        </ul>
                                    </div>
                                </div>
                                <div class="choose-service">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_no" id="phone_no"
                                            value="{{ Session::get('user_phone_no') }}"
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="custom-check-box">
                                                    <div class="custom-controls-stacked">
                                                        <label class="custom-control material-checkbox fl">
                                                            ...
                                                            <span class="material-control-indicator"></span>
                                                            <span
                                                                class="description">{{ __('message.Stripe') }}</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="custom-check-box">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control material-checkbox fl">
                                                                ...
                                                                <span class="material-control-indicator"></span>
                                                                <span
                                                                    class="description">{{ __('message.Rave') }}</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="custom-check-box">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control material-checkbox fl">
                                                                ...
                                                                <span class="material-control-indicator"></span>
                                                                <span
                                                                    class="description">{{ __('message.Paytm') }}</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="custom-check-box">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control material-checkbox fl">
                                                                ...
                                                                <span class="material-control-indicator"></span>
                                                                <span
                                                                    class="description">{{ __('message.Braintree') }}</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="custom-check-box">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control material-checkbox fl">
                                                                ...
                                                                <span class="material-control-indicator"></span>
                                                                <span
                                                                    class="description">{{ __('message.Razorpay') }}</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="custom-check-box">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control material-checkbox fl">
                                                                ...
                                                                <span class="material-control-indicator"></span>
                                                                <span
                                                                    class="description">{{ __('message.Paystack') }}</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="text-center">
                                            @if (Session::has('user_id'))
                                                <button class="theme-btn-one centred" type="button" id="show_book"
                                                    onclick="bookshow()">{{ __('message.Book Appointment') }}<i
                                                        class="icon-Arrow-Right"></i></button>
                                            @else
                                                <button type="button" class="theme-btn-one" onclick="pleaselogin()"
                                                    id="show_book">{{ __('message.Book Appointment') }}<i
                                                        class="icon-Arrow-Right"></i></button>
                                            @endif
                                        </div>
                                                ...
                                                <div class="btn-box" id="btnappointment">
                                                    @if (Session::has('user_id') && Session::get('role_id') == '1')
                                                        <button class="theme-btn-one"
                                                            type="submit">{{ __('message.Book Appointment') }}<i
                                                                class="icon-Arrow-Right"></i></button>
                                                    @else
                                                        <button type="button" class="theme-btn-one"
                                                            onclick="pleaselogin()">{{ __('message.Book Appointment') }}<i
                                                                class="icon-Arrow-Right"></i></button>
                                                    @endif
                                                </div>
                                            </form>
                                            ...
                                            <form action="{{ url('makeappointment') }}" method="post"
                                                ...
                                                @if (Session::has('user_id') && Session::get('role_id') == '1')
                                                    <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="{{ env('STRIPE_KEY') }}"
                                                        data-amount="" data-id="stripid" data-name="{{ __('message.System Name') }}"
                                                        data-label="{{ __('message.Book Appointment') }}" data-description=""
                                        ...
                                        <div id="razorpay_div" style="display:none;">
                                            <form action="{{ url('makeappointment') }}" method="post"
                                                ...
                                                <input id="nonce" name="payment_method_nonce" type="hidden" />
                                                @if (Session::has('user_id') && Session::get('role_id') == '1')
                                                    <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="{{ $paymentdetail['razorpay_razorpay_key'] }}"
                                                        data-amount="{{ (int) $data->consultation_fees * 100 }}" data-buttontext='{{ __('message.Pay') }}'
                                                        data-name="{{ env('APP_NAME') }}" data-description="Payment"
                                                        data-image="{{ asset('public/image_web/896814.png') }}" data-prefill.name="name" data-prefill.email="email"
