    ...
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1>{{ __('message.Laboratory Details') }}</h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <div class="auto-container">
                <ul class="bread-crumb clearfix">
                    ...
                    <li>{{ __('message.Laboratory Details') }}</li>
                </ul>
            </div>
        </div>
    </section>
                                                ...
                                                <li style="text-align: center;">
                                                    ...
                                                    @if (Session::has('user_id') && Session::get('role_id') == '1')
                                                        <a href="#" class="theme-btn-one" data-toggle="modal"
                                                            ...
                                                            style="padding: 12px 30px;margin-left: 140px;">{{ __('message.Upload Prescription') }}</a>
                                                    @else
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">
                                                {{ __('message.Add Prescription') }}</h5>
                                        ...
                                        <div class="modal-body">
                                            <div>
                                                <form action="{{ url('upload_pre_order') }}" method="post"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="address" id="address1"
                                                            placeholder="{{ __('message.Enter') }} {{ __('message.Address') }}"
                                                            required="">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="btn-box" id="btnappointment">
                                                        <button class="theme-btn-one" type="submit"
                                                            style="box-shadow:none;">{{ __('message.submit') }}</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="clinic-block-one mb-3"
                                                            ...
                                                            <div class="inner-box"
                                                                ...
                                                                <figure class="image-box" style="height: 10px;top: 20px;">
                                                                    <img src="{{ asset('public/upload/laboratoryreport') . '/' . $dl->image }}"
    ...
    @if (session()->get('cart') != null)
        <div class="choose-service">
            ...
            <div id="braintree_div" style="display:none;">
                <form action="{{ url('addlaboratoryorder') }}" method="post" id="payment-form">
                    {{ csrf_field() }}
                    <input type="hidden" name="laboratory_id" id="laboratory_id" value="{{ $data->id }}">
            ...
            <div id="stripe_div" style="display:none;">
                <form action="{{ url('addlaboratoryorder') }}" method="post" id="stripe-form">
                    {{ csrf_field() }}
                    ...
                    @if (Session::has('user_id') && Session::get('role_id') == '1')
                        <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="{{ env('STRIPE_KEY') }}"
                            data-amount="{{ $subtotal * 100 }}" data-id="stripid" data-name="{{ __('message.System Name') }}"
            ...
            <div id="paytm_div" style="display:none;">
                <form action="{{ url('addlaboratoryorder') }}" method="post" id="payment-form">
                    {{ csrf_field() }}
                    <input type="hidden" name="labratory_id" id="laboratory_id" value="{{ $data->id }}">
                    <input type="hidden" name="total" value="{{ $subtotal }}">
                    <input type="hidden" name="tax" value="{{ $subtotal2 }}">
                    <input type="hidden" name="delivery_charge" value="{{ $setting->pharmacy_delivery_charge }}">
                ...
                <form action="{{ url('addlaboratoryorder') }}" method="post" id="payment-form">
                    ...
                    @if (Session::has('user_id') && Session::get('role_id') == '1')
                        <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="{{ $paymentdetail['razorpay_razorpay_key'] }}"
                            data-amount="{{ (int) $subtotal * 100 }}" data-buttontext='{{ __('message.Pay') }}'
