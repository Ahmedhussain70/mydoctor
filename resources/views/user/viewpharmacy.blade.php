                            ...
                            <div class="tabs-box">
                                <div class="tab-btn-box centred">
                                    <ul class="tab-btns tab-buttons clearfix">
                                        <li class="tab-btn active-btn" data-tab="#tab-3">{{ __('message.Medicine') }}
                                        </li>
                                                        ...
                                                        <div class="clinic-block-one mb-3"
                                                            ...
                                                            <div class="inner-box"
                                                                ...
                                                                <figure class="image-box" style="height: 10px;top: 20px;">
                                                                    <img src="{{ asset('public/upload/pharmacymedicine') . '/' . $dl->image }}"
