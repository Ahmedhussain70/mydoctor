...
Route::group(['middleware' => ['Localization']], function () {
    ...
    Route::post('/gemini/call', [ChatController::class, 'callGeminiAPI'])->name('gemini.call');
    Route::post('/gemini/clear', [ChatController::class, 'clearChat'])->name('gemini.clear');
    ...
    Route::group(['prefix' => '/'], function () {
        ...
        Route::get("earningreports", [DoctorController::class, "earningreports"]);
        ...
        Route::group(['prefix' => 'backend'], function () {
            ...
            Route::get("add_city/{id}", [CityController::class, "add_city"]);
            Route::get("delete_city/{id}", [CityController::class, "delete_city"]);
            Route::post("save_city", [CityController::class, "save_city"]);
        });
    });
});
// });
