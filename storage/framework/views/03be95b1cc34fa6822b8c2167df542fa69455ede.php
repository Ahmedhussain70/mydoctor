...
<section class="doctors-dashboard bg-color-3">
      ...
      <div class="profile-box">
         ...
         <div class="profile-info">
            <ul class="list clearfix">
                ...
                <li><a href="<?php echo e(url('laboratoryreport')); ?>"><i class="fas fa-pills"></i><?php echo e(__('message.Report')); ?></a></li>
                ...
                <li><a href="<?php echo e(url('laboratorychangepassword')); ?>"  class="current"><i class="fas fa-unlock-alt"></i><?php echo e(__('message.Change Password')); ?></a></li>
   ...
   <input type="hidden" id="ccpp" value="<?php echo e($doctordata->password); ?>">
</section>
<script>
function chengepswd() {
    // Get the form fields
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/laboratory/changepassword.blade.php ENDPATH**/ ?>