            ...
            <div class="col-xl-9 col-md-12">
               <div class="card">
                  <div class="card-body">
                     ...
                     <?php endif; ?>
                     <form action="<?php echo e(url('backend/sendnews')); ?>" method="post" >
                        ...
                        <p> <span style="color:red">*</span> <?php echo e(__("message.You can send email to news users who have subscribed news on website")); ?></p>
