<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.Search Laboratory')); ?>
    ...
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1><?php echo e(__('message.Search Laboratory')); ?></h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <div class="auto-container">
                <ul class="bread-crumb clearfix">
                    ...
                    <li><?php echo e(__('message.Search Laboratory')); ?></li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="auto-container">
            <div class="content-box">
                <div class="form-inner clearfix">
                    <form action="<?php echo e(url('searchlaboratory')); ?>" method="get">
                        <div class="form-group clearfix">

                            <input type="text" name="term" value="<?php echo e($term); ?>" id="term"
                                placeholder="Ex. <?php echo e(__('message.Laboratory')); ?> <?php echo e(__('message.Name')); ?>" required="">
                                    ...
                                    <div class="inner-box">
                                        ...
                                        <div class="content-box">
                                            ...
                                            <ul class="name-box clearfix">
                                                <li class="name">
                                                    <h3><a
                                                            href="<?php echo e(url('viewlaboratory') . '/' . $dl->id); ?>"><?php echo e($dl->name); ?></a>
                                                    </h3>
                                                </li>
                                            ...
                                            <div class="rating-box clearfix">
                                                <ul class="rating clearfix">
                                                    ...
                                                    <li><a
                                                            href="<?php echo e(url('viewlaboratory') . '/' . $dl->id); ?>">(<?php echo e($dl->totalreview); ?>)</a>
                                                    </li>
                                                </ul>
                                                <div class="link"><a
                                                        href="<?php echo e(url('viewlaboratory') . '/' . $dl->id); ?>"><?php echo e($dl->working_time); ?></a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="btn-box"><a
                                                    href="<?php echo e(url('viewlaboratory') . '/' . $dl->id); ?>"><?php echo e(__('message.Visit Now')); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="team-block-three">
                                            <div class="inner-box">
                                                <figure class="image-box">
                                                    ...
                                                    <?php else: ?>
                                                        <img src="<?php echo e(asset('public/upload/doctors/defaultlaboratory.png')); ?>"
                                                            alt="" style="height: 245px;">
                                                    <?php endif; ?>
                                                    <?php if($dl->is_fav == '0'): ?>
                                                        <?php if(empty(Session::has('user_id'))): ?>
...
<?php $__env->startSection('footer'); ?>
    <script type="text/javascript">
        function serachcity(val) {
            ...
            if (term === "") {
                if (val !== "") {
                    window.location.href = '<?php echo e(url('searchlaboratory')); ?>' + '?city_id=' + val;
                }
            } else {

                window.location.href = '<?php echo e(url('searchlaboratory')); ?>' + '?city_id=' + val + '&term=' + term;
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/all_laboratory.blade.php ENDPATH**/ ?>