...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                href="<?php echo e(url('backend/dashboard')); ?>">
            ...
            <li class="nav-item <?php echo e(Request::is('backend/dashboard') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/dashboard')); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span><?php echo e(__('message.Dashboard')); ?></span></a>
            </li>
            <hr class="sidebar-divider">
            <div class="sidebar-heading">
                <?php echo e(__('message.Doctors')); ?>
            ...
            <li class="nav-item <?php echo e(Request::is('backend/patients') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/patients')); ?>">
                    <i class="fas fa-users fa-palette"></i>
                    <span><?php echo e(__('message.Patients')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/services') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/services')); ?>">
            ...
            <li class="nav-item <?php echo e(Request::is('backend/pharmacy') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/pharmacy')); ?>">
                    <i class="fas fa-clinic-medical"></i>
                    <span><?php echo e(__('message.Pharmacy')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/pharmacyorder') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/pharmacyorder')); ?>">
                    <i class="fab fa-jedi-order"></i>
                    <span><?php echo e(__('message.Pharmacy Order')); ?></span>
                </a>
            </li>
             <li class="nav-item <?php echo e(Request::is('backend/medicines') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/medicines')); ?>">
            ...
            <hr class="sidebar-divider">
            <div class="sidebar-heading">
                <?php echo e(__('message.Laboratory')); ?>

            </div>
            <li class="nav-item <?php echo e(Request::is('backend/laboratory') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/laboratory')); ?>">
                 <i class="fas fa-flask"></i>
                    <span><?php echo e(__('message.Laboratory')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/laboratoryorder') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/laboratoryorder')); ?>">
                 <i class="fas fa-flask"></i>
            ...
            <li class="nav-item <?php echo e(Request::is('backend/city') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/city')); ?>">
                    <i class="fas fa-fw fa-pills"></i>
                    <span><?php echo e(__('message.city')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/banner') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/banner')); ?>">
                    <i class="fas fa-fw fa-image"></i>
                    <span><?php echo e(__('message.banner')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/reviews') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/reviews')); ?>">
                    <i class="fas fa-fw fa-star"></i>
                    <span><?php echo e(__('message.Review')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/complain') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/complain')); ?>">
                    <i class="fas fa-fw fa-palette"></i>
                    <span><?php echo e(__('message.complain')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/contact_list') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/contact_list')); ?>">
                    <i class="fas fa-file-contract"></i>
                    <span><?php echo e(__('message.Contact')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/news') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/news')); ?>">
                    <i class="fas fa-fw fa-palette"></i>
                    <span><?php echo e(__('message.News')); ?></span>
                </a>
            </li>
           
            <li class="nav-item <?php echo e(Request::is('backend/languages/en') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/languages/en')); ?>">
            ...
            <li class="nav-item <?php echo e(Request::is('backend/about') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/about')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span><?php echo e(__('message.About')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/Terms_condition') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/Terms_condition')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span><?php echo e(__('message.term')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/app_privacy') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/app_privacy')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span><?php echo e(__('message.Privecy')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/data_deletion') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/data_deletion')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
            ...
            <li class="nav-item <?php echo e(Request::is('backend/doctor_report') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('doctor_report')); ?>">
                    <i class="fas fa-address-book"></i>
                    <span><?php echo e(__('message.Doctors')); ?> </span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/user_report') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('user_report')); ?>">
                    <i class="fas fa-address-book"></i>
                    <span><?php echo e(__('message.Patients')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/do_sub_report') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(route('do_sub_report')); ?>">
                    <i class="fas fa-address-book"></i>
                    <span><?php echo e(__('message.Doctor Subscription')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/app_book_report') ? 'active' : ''); ?>">
            ...
            <li class="nav-item <?php echo e(Request::is('backend/pending_payment') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/pending_payment')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
            ...
            <li class="nav-item <?php echo e(Request::is('backend/subscriber_doc') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/subscriber_doc')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span><?php echo e(__('message.Subscriber')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/complete_payment') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/complete_payment')); ?>">
                    <i class="fas fa-fw fa-chart-area"></i>
            ...
            <li class="nav-item <?php echo e(Request::is('backend/sendnotification') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/sendnotification')); ?>">
                    <i class="fab fa-snapchat-ghost"></i>
                    <span><?php echo e(__('message.Send Notification')); ?></span>
                </a>
            </li>
            <li class="nav-item <?php echo e(Request::is('backend/notificationkey') ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('backend/notificationkey')); ?>">
                ...
                <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
                    ...
                    <ul class="navbar-nav <?php if(__('message.RTL') == 1): ?> ml-auto <?php endif; ?>"
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="">
                                 <?php echo e($color->lang_code); ?> <i class="fas fa-angle-down ml-2"></i>
                            </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?php echo e(url('backend/editprofile')); ?>">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    <?php echo e(__('message.View Profile')); ?>

                                </a>
                                <a class="dropdown-item" href="<?php echo e(url('backend/setting')); ?>">
                                    <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                                    <?php echo e(__('message.Setting')); ?>

                                </a>
                                <a class="dropdown-item" href="<?php echo e(url('backend/changepassword')); ?>">
                                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                                    <?php echo e(__('message.Change Password')); ?>

                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo e(url('backend/logout')); ?>">
    ...
    <input type="hidden" id="siteurl" value="<?php echo e(url('backend')); ?>" />
...
<?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/admin/layout.blade.php ENDPATH**/ ?>