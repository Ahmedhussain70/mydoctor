<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.Search Pharmacy')); ?>
    ...
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1><?php echo e(__('message.Search Pharmacy')); ?></h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <div class="auto-container">
                <ul class="bread-crumb clearfix">
                    ...
                    <li><?php echo e(__('message.Search Pharmacy')); ?></li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="auto-container">
            <div class="content-box">
                <div class="form-inner clearfix">
                    <form action="<?php echo e(url('searchpharmacy')); ?>" method="get">
                        <div class="form-group clearfix">

                            <input type="text" name="term" value="<?php echo e($term); ?>" id="term"
                                placeholder="Ex. <?php echo e(__('message.Pharmacy')); ?> <?php echo e(__('message.Name')); ?>" required="">
                                ...
                                <div class="clinic-block-one">
                                    <div class="inner-box">
                                        ...
                                        <figure class="image-box">
                                            ...
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('public/upload/doctors/defaultpharmacy.png')); ?>"
                                                    alt="" style="height: 155px;">
                                            <?php endif; ?>
                                        ...
                                        <div class="content-box">
                                            ...
                                            <ul class="name-box clearfix">
                                                <li class="name">
                                                    <h3><a
                                                            href="<?php echo e(url('viewpharmacy') . '/' . $dl->id); ?>"><?php echo e($dl->name); ?></a>
                                                    </h3>
                                                </li>
                                            ...
                                            <div class="rating-box clearfix">
                                                <ul class="rating clearfix">
                                                    ...
                                                    <li><a
                                                            href="<?php echo e(url('viewpharmacy') . '/' . $dl->id); ?>">(<?php echo e($dl->totalreview); ?>)</a>
                                                    </li>
                                                </ul>
                                                <div class="link"><a
                                                        href="<?php echo e(url('viewpharmacy') . '/' . $dl->id); ?>"><?php echo e($dl->working_time); ?></a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="btn-box"><a
                                                    href="<?php echo e(url('viewpharmacy') . '/' . $dl->id); ?>"><?php echo e(__('message.Visit Now')); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->startSection('footer'); ?>
    <script type="text/javascript">
        function serachcity(val) {
            ...
            if (term === "") {
                if (val !== "") {
                    window.location.href = '<?php echo e(url('searchpharmacy')); ?>' + '?city_id=' + val;
                }
            } else {

                window.location.href = '<?php echo e(url('searchpharmacy')); ?>' + '?city_id=' + val + '&term=' + term;
    ...
    <script>
       ...
       <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e($setting->map_api_key); ?>&libraries=places&callback=initMap"
    async defer></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\krupa\doctorlab\resources\views/user/allpharmacy.blade.php ENDPATH**/ ?>