                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(url('backend/doctors')); ?>"><?php echo e(__('message.Doctors')); ?></a>
                            </li>
            ...
            <div class="col-xl-8 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(url('backend/updatedoctor')); ?>" class="needs-validation" method="post"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder='<?php echo e(__('message.Enter Doctor Name')); ?>' id="name"
                                            name="name" required=""
                                            value="<?php echo e(isset($data->name) ? $data->name : ''); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password"
                                            placeholder='<?php echo e(__('message.Enter password')); ?>' name="password" required="" minlength="6"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="aboutus"><?php echo e(__('message.consultation_fees')); ?><span
                                                class="reqfield">*</span></label>
                                        <input type="number" required name="consultation_fees"
                                            value="<?php echo e(isset($data->consultation_fees) ? $data->consultation_fees : ''); ?>"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    ="healthcare"
                                            placeholder='<?php echo e(__('message.Enter Health Care')); ?>' rows="5" required=""><?php echo e(isset($data->healthcare) ? $data->healthcare : ''); ?></textarea>
                                    </div>
                                </div>

                            </div>
                            <div class="form-group">
                                <label for="department_id"><?php echo e(__('message.city')); ?><span
                                        class="reqfield">*</span></label>
                                <select class="form-control" name="city_id" id="city_id" required="">
                                    <option value="">
                                        <?php echo e(__('message.select')); ?> <?php echo e(__('message.city')); ?>
                                    ...
                                    <?php $__currentLoopData = $city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($c->id); ?>"
                                            <?= isset($data->city_id) && $data->city_id == $c->id ? 'selected="selected"' : '' ?> > <?php echo e($c->city_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
