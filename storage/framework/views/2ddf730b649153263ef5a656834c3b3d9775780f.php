                ...
                <div class="card">
                    <div class="card-body">
                        <div>
                            ...
                            <p> <a href="<?php echo e(url('backend/addmedicine/' . $pharmacy_id . '/0')); ?>" type="button"  class="btn btn-primary waves-effect waves-light mb-3 float-right"></i><?php echo e(__('message.Add')); ?> <?php echo e(__('message.Medicine')); ?></a></p>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\krupa\doctorlab\resources\views/admin/pharmacy/pharmacymedicine.blade.php ENDPATH**/ ?>