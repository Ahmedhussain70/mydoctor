                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <form action="<?php echo e(url('backend/updatesettingfour')); ?>" method="post"
                                    ...
                                    <!--<div class="form-group">-->
                                    <!--    <label for="name" class=" form-control-label">-->
                                    <!--        <?php echo e(__('message.Map')); ?>-->
                                    <!--        <span class="reqfield">*</span>-->
                                    <!--    </label>-->
                                    <!--    <select class="form-control" name="map" id="map" required="">-->
                                    <!--        -->
                                    <!--        <?php echo $__env->make('admin.map-type', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>-->
                                    <!--    </select>-->
                                    <!--</div>-->
                                    <div class="row">
                                        <div class="col-6">
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <form action="<?php echo e(url('backend/updatesettingone')); ?>" method="post"
                                    enctype="multipart/form-data">
                                    <?php echo e(csrf_field()); ?>
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                <form action="<?php echo e(url('backend/updatesettingtwo')); ?>" method="post"
                                    enctype="multipart/form-data">
                                    <?php echo e(csrf_field()); ?>
