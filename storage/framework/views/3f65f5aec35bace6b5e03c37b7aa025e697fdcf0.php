                                ...
                                <div class="inner-box">
                                    <figure class="image-box">
                                        ...
                                        <div class="doctor-detail-page-main-box"
                                            style="background-image:url('<?php echo e($path); ?>'); background-size: 311px 220px;">
                                        </div>
                                    </figure>
                                    <div class="content-box">
                                        ...
                                        <div class="like-box">
                                            <?php if($data->is_fav == '0'): ?>
                                                <?php if(empty(Session::has('user_id'))): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <a href="javascript:userfavorite('<?php echo e($data->id); ?>')"
                                        ...
                                        <div class="lower-box clearfix">
                                            <ul class="info clearfix">
                                                <li><i
                                                        class="fas fa-map-marker-alt"></i><?php echo e(substr($data->address, 0, 40)); ?>

                                                </li>
                                                <li><i class="fas fa-phone"></i><a
                                                        href="<?php echo e($data->phoneno); ?>"><?php echo e($data->phoneno); ?></a></li>
                                            </ul>
                                            <div class="view-map"><a
                                                    href="https://maps.google.com/?q=<?php echo e($data->lat); ?>,<?php echo e($data->lon); ?>"
                                                    target="_blank"><?php echo e(__('message.View Map')); ?></a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="btn-box">
                                                <form action="<?php echo e(url('savereview')); ?>" method="post">
                                                    ...
                                                    <input type="hidden" name="user_id"
                                                        value="<?php echo e(Session::get('user_id')); ?>">
                                                    <div class="row clearfix">
                                                        <div class="col">
                                                            ...
                                                            <div id="full-stars-example-two">
                                                                <div class="rating-group">
                                                                    <input disabled checked
                                                                        ...
                                                                        name="rating3" id="rating3-none" value="1"
                                                                        type="radio" required>
                                                                    <label aria-label="1 star" class="rating__label"
                                                                        for="rating3-1"><i
                                                                            class="rating__icon rating__icon--star fa fa-star"></i></label>
                                                                    <input class="rating__input" name="rating3"
                                                        ...
                                                        <?php if(Session::has('user_id') && Session::get('role_id') == '1'): ?>
                                                            <button
                                                                class="theme-btn-one"><?php echo e(__('message.Submit Review')); ?><i
                                                                    class="icon-Arrow-Right"></i></button>
                                                        <?php else: ?>
                                                            <a href="<?php echo e(url('patientlogin')); ?>"
                                                                class="theme-btn-one"><?php echo e(__('message.Submit Review')); ?></a>
                                                        <?php endif; ?>
                            ...
                            <div class="form-widget">
                                ...
                                <div class="form-inner">
                                    <div class="appointment-time">
                                        ...
                                        <p><?php echo e(__('message.consultation_fees')); ?> : <?php echo e($currency[1]); ?><span
                                                id="consultation_fees"><?php echo e($data->consultation_fees); ?></span></p>
                                        <input type="hidden" name="doctor_id" id="doctor_id"
                                            value="<?php echo e($data->id); ?>">
                                        <input type="hidden" name="consultation_fees"
                                            value="<?php echo e($data->consultation_fees); ?>">
                                        <div class="form-group">
                                            <input type="text" name="date" id="date"
                                                value="<?php echo e(date('m/d/Y')); ?>" id="datepicker"
                                                onchange="slotdivchange(this.value)">
                                            <i class="fas fa-calendar-alt"></i>
                                        </div>
                                        <?php if(!empty($schedule)): ?>
                                            <div class="custom-dropdown" id="timerange"
                                                style="    width: 100%;margin-bottom: 10px;">
                                                <select class="" name="slottime" id="slottime" required=""
                                                    onchange="slotchange(this.value)">
                                                    <?php $__currentLoopData = $schedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($s['id']); ?>" data-display-text="Fruits">
                                        ...
                                        <div class="custom-slot-design-box">
                                                        ...
                                                        <?php $__currentLoopData = $schedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php $__currentLoopData = $s['slottime']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ns): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li>
                                                                    <?php if($ns['is_book'] == 0): ?>
                                                                        <input type='radio'
                                                                            value='<?php echo e($ns['id'] . '#' . $ns['name']); ?>'
                                                                            name='slot' id='<?php echo e($ns['id']); ?>' />
                                                                        <label
                                                                            for='<?php echo e($ns['id']); ?>'><?php echo e($ns['name']); ?></label>
                                                                    <?php else: ?>
                                                                        <input type='radio'
                                                                            value='<?php echo e($ns['id'] . '#' . $ns['name']); ?>'
                                                                            name='slot' id='<?php echo e($ns['id']); ?>'
                                                                        ...
                                                                        <label class="custom-radio-disabled"
                                                                            for='radio4'><?php echo e($ns['name']); ?></label>
                                                                    <?php endif; ?>
                                                                </li>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <?php break; ?>;
                                            ...
                                            <?php else: ?>
                                                <p style="color: red;margin-left: 10px;">
                                                    <?php echo e(__('message.Doctor isnot Avilable')); ?></p>
                                            <?php endif; ?>
                                        </ul>
                                    </div>
                                </div>
                                <div class="choose-service">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_no" id="phone_no"
                                            value="<?php echo e(Session::get('user_phone_no')); ?>"
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="custom-check-box">
                                                    <div class="custom-controls-stacked">
                                                        <label class="custom-control material-checkbox fl">
                                                            <input type="radio" class="material-control-input"
                                                                name="payment_type" id="payment_type_cod"
                                                                value="3" onchange="changeform(this.value)">
                                            ...
                                            <div class="col-md-6">
                                                <div class="custom-check-box">
                                                    <div class="custom-controls-stacked">
                                                        <label class="custom-control material-checkbox fl">
                                                            <input type="radio" class="material-control-input"
                                                                name="payment_type" id="payment_type_stripe"
                                                                value="2" onchange="changeform(this.value)">
                                                            <span class="material-control-indicator"></span>
                                                            <span
                                                                class="description"><?php echo e(__('message.Stripe')); ?></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="custom-check-box">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control material-checkbox fl">
                                                                <input type="radio" class="material-control-input"
                                                                    name="payment_type" id="payment_type_rave"
                                                                    value="4" onchange="changeform(this.value)">
                                                                <span class="material-control-indicator"></span>
                                                                <span
                                                                    class="description"><?php echo e(__('message.Rave')); ?></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="custom-check-box">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control material-checkbox fl">
                                                                <input type="radio" class="material-control-input"
                                                                    name="payment_type" id="payment_type_paytm"
                                                                    value="5" onchange="changeform(this.value)">
                                                                <span class="material-control-indicator"></span>
                                                                <span
                                                                    class="description"><?php echo e(__('message.Paytm')); ?></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="custom-check-box">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control material-checkbox fl">
                                                                <input type="radio" class="material-control-input"
                                                                    name="payment_type" id="payment_type_braintree"
                                                                    value="1" onchange="changeform(this.value)">
                                                                <span class="material-control-indicator"></span>
                                                                <span
                                                                    class="description"><?php echo e(__('message.Braintree')); ?></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="custom-check-box">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control material-checkbox fl">
                                                                <input type="radio" class="material-control-input"
                                                                    name="payment_type" id="payment_type_razorpay"
                                                                    value="6" onchange="changeform(this.value)">
                                                                <span class="material-control-indicator"></span>
                                                                <span
                                                                    class="description"><?php echo e(__('message.Razorpay')); ?></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="custom-check-box">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control material-checkbox fl">
                                                                <input type="radio" class="material-control-input"
                                                                    name="payment_type" id="payment_type_paystack"
                                                                    value="7" onchange="changeform(this.value)">
                                                                <span class="material-control-indicator"></span>
                                                                <span
                                                                    class="description"><?php echo e(__('message.Paystack')); ?></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="text-center">
                                            <?php if(Session::has('user_id')): ?>
                                                <button class="theme-btn-one centred" type="button" id="show_book"
                                                    onclick="bookshow()"><?php echo e(__('message.Book Appointment')); ?><i
                                                        class="icon-Arrow-Right"></i></button>
                                            <?php else: ?>
                                                <button type="button" class="theme-btn-one" onclick="pleaselogin()"
                                                    id="show_book"><?php echo e(__('message.Book Appointment')); ?><i
                                                        class="icon-Arrow-Right"></i></button>
                                            <?php endif; ?>
                                        </div>
                                        <div id="braintree_div" style="display:none;">
                                            <form action="<?php echo e(url('makeappointment')); ?>" method="post"
                                                id="payment-form">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <div class="btn-box" id="btnappointment">
                                                    <?php if(Session::has('user_id') && Session::get('role_id') == '1'): ?>
                                                        <button class="theme-btn-one"
                                                            type="submit"><?php echo e(__('message.Book Appointment')); ?><i
                                                                class="icon-Arrow-Right"></i></button>
                                                    <?php else: ?>
                                                        <button type="button" class="theme-btn-one"
                                                            onclick="pleaselogin()"><?php echo e(__('message.Book Appointment')); ?><i
                                                                class="icon-Arrow-Right"></i></button>
                                                    <?php endif; ?>
                                                </div>
                                            </form>
                                        ...
                                        <div id="stripe_div" style="display:none;">
                                            <form action="<?php echo e(url('makeappointment')); ?>" method="post"
                                                ...
                                                <input type="hidden" name="consultation_fees"
                                                    value="<?php echo e($data->consultation_fees); ?>">
                                                <?php if(Session::has('user_id') && Session::get('role_id') == '1'): ?>
                                                    <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="<?php echo e(env('STRIPE_KEY')); ?>"
                                                        data-amount="" data-id="stripid" data-name="<?php echo e(__('message.System Name')); ?>"
                                                        data-label="<?php echo e(__('message.Book Appointment')); ?>" data-description=""
                                                        data-image="<?php echo e(asset('public/image_web/') . '/' . $setting->logo); ?>" data-locale="auto"></script>
                                                <?php else: ?>
                                                    <button type="button" class="theme-btn-one"
                                                        onclick="pleaselogin()"><?php echo e(__('message.Book Appointment')); ?><i
                                                            class="icon-Arrow-Right"></i></button>
                                        ...
                                        <div id="razorpay_div" style="display:none;">
                                            <form action="<?php echo e(url('makeappointment')); ?>" method="post"
                                                ...
                                                <input id="nonce" name="payment_method_nonce" type="hidden" />
                                                <?php if(Session::has('user_id') && Session::get('role_id') == '1'): ?>
                                                    <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="<?php echo e($paymentdetail['razorpay_razorpay_key']); ?>"
                                                        data-amount="<?php echo e((int) $data->consultation_fees * 100); ?>" data-buttontext='<?php echo e(__('message.Pay')); ?>'
                                                        data-name="<?php echo e(env('APP_NAME')); ?>" data-description="Payment"
                                                        data-image="<?php echo e(asset('public/image_web/896814.png')); ?>" data-prefill.name="name" data-prefill.email="email"
                                                        data-theme.color="#d18217"></script>
                                                <?php else: ?>
                                                    <button type="button" class="theme-btn-one"
                                                        onclick="pleaselogin()"><?php echo e(__('message.Book Appointment')); ?><i
                                                            class="icon-Arrow-Right"></i></button>
                                        ...
                                        <div id="uploaded_receipt_div" style="display:none;">
                                            <form action="<?php echo e(url('makeappointment')); ?>" method="post"
                                                id="payment-form">
                                                <?php echo e(csrf_field()); ?>
                                                ...
                                                <input type="hidden" name="consultation_fees"
                                                    value="<?php echo e($data->consultation_fees); ?>">
                                                <input type="hidden" name="phone_no" id="phone_no_8">
                                                <input type="hidden" name="date" id="date_8">
                                                <input type="hidden" name="slot" id="slot_8">
                                                <input type="hidden" name="message" id="message_8">
                                                <input type="hidden" name="payment_type" value="Uploaded Receipt">
                                                <div class="bt-drop-in-wrapper">
                                                    <div id="bt-dropin"></div>
                                                </div>
                                                <input id="nonce" name="payment_method_nonce" type="hidden" />
...
<script>
    function changeform(val) {
        ...
        if (phone_no != "" && date != "" && message != "" && slot !== undefined) {
            if ($("#payment_type_braintree").prop("checked") == true) {
                ...
                $("#uploaded_receipt_div").css("display", "none");
            ...
            if ($("#payment_type_paystack").prop("checked") == true) {
             ...
             if ($("#payment_type_uploaded_receipt").prop("checked") == true) {
                $("#razorpay_div").hide();
                $("#braintree_div").hide();
                $("#stripe_div").hide();
                $("#cod_div").hide();
                $("#paytm_div").hide();
                $("#rave_div").hide();
                $("#paystack_div").hide(); // maybe hide this too?
                $("#uploaded_receipt_div").show(); // <-- Add this if needed
                $("#phone_no_8").val(phone_no);
                $("#date_8").val(date);
                $("#message_8").val(message);
                $("#slot_8").val(slot);
            }
            ...
            $("#payment_type_paystack").prop("checked", false);
             $("#payment_type_uploaded_recipt").prop("checked", false);
        }
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\krupa\doctorlab\resources\views/user/viewdoctor.blade.php ENDPATH**/ ?>