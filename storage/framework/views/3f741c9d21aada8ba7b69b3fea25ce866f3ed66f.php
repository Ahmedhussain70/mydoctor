               ...
               <div class="page-title-box d-flex align-items-center justify-content-between">
                  ...
                  <div class="page-title-right">
                     <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="<?php echo e(url('backend/sendnotification')); ?>"><?php echo e(__("message.Notification")); ?></a></li>
            ...
            <div class="col-xl-6 col-md-12">
               <div class="card">
                  <div class="card-body">
                     ...
                     <?php endif; ?>
                     <form action="<?php echo e(url('backend/sendnotificationtouser')); ?>" method="post">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\krupa\doctorlab\resources\views/admin/addnotification.blade.php ENDPATH**/ ?>