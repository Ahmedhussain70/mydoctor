<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.Favourite')); ?>
    ...
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1><?php echo e(__('message.Favourite')); ?></h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <ul class="bread-crumb clearfix">
                ...
                <li><?php echo e(__('message.Favourite')); ?></li>
            </ul>
        </div>
    </section>
            ...
            <div class="profile-box patient-profile">
                ...
                <div class="profile-info">
                    <ul class="list clearfix">
                        ...
                        <li><a href="<?php echo e(url('favouriteuser')); ?>" class="current"><i
                        ...
                        <div class="doctors-list">
                            <div class="row clearfix">
                                <?php if(count($userfavorite) > 0): ?>
                                    <?php $__currentLoopData = $userfavorite; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-xl-4 col-lg-6 col-md-12 doctors-block">
                                            <div class="team-block-three">
                                                <div class="inner-box">
                                                    <figure class="image-box">
                                                        <img src="<?php echo e(asset('public/upload/doctors') . '/' . $uf->doctorls->image); ?>"
                                                            alt="">
                                                        <a href="javascript:userfavoritedashboard('<?php echo e($uf->doctor_id); ?>')"
                                                            class="activefav"><i class="far fa-heart"></i></a>
                                                    </figure>
                                                    <div class="lower-content">
                                                        <ul class="name-box clearfix">
                                                            <li class="name">
                                                                <h3><a
                                                                        href="<?php echo e(url('viewdoctor') . '/' . $uf->doctor_id); ?>"><?php echo e(substr($uf->doctorls->name, 0, 10)); ?></a>
                                                                </h3>
                                                            </li>
                                                        ...
                                                        <span
                                                            class="designation"><?php echo e($uf->doctorls->department_name); ?></span>
                                                        <div class="rating-box clearfix">
                                                            <ul class="rating clearfix">
                                                                ...
                                                                <li><a
                                                                        href="">(<?php echo e($uf->doctorls->totalreview); ?>)</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="location-box">
                                                            <p><i
                                                                    class="fas fa-map-marker-alt"></i><?php echo e(substr($uf->doctorls->address, 0, 25)); ?>

                                                            </p>
                                                        </div>
                                                        <div class="lower-box clearfix">
                                                            <a
                                                                href="<?php echo e(url('viewdoctor') . '/' . $uf->doctor_id); ?>"><?php echo e(__('message.Book Now')); ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <?php else: ?>
                                    <?php echo e(__('message.No any doctors In your Favorite list')); ?>

                                <?php endif; ?>
                            </div>
                        </div>
                        <?php echo e($userfavorite->links()); ?>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/patient/favourite.blade.php ENDPATH**/ ?>