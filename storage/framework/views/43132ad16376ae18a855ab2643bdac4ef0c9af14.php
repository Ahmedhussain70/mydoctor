                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><a class="btn btn-primary float-right"
                                href="<?php echo e(url('backend/savedoctor/0')); ?>"><?php echo e(__('message.Add Doctor')); ?></a></p>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/admin/doctor/default.blade.php ENDPATH**/ ?>