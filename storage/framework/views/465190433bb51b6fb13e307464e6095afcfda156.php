      ...
      <div class="container-fluid">
               ...
               <div class="page-title-box d-flex align-items-center justify-content-between">
                  ...
                  <div class="page-title-right">
                     <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="<?php echo e(url('backend/services')); ?>"><?php echo e(__("message.specialities")); ?></a></li>
         ...
         <div class="row" style="display: flex;justify-content: center;">
            <div class="col-xl-6 col-md-12">
               <div class="card">
                  <div class="card-body">
                     <form action="<?php echo e(url('backend/updateservice')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <?php if($data): ?>
                           <img src="<?php echo e(asset('public/upload/services').'/'.$data->icon); ?>" style="width: 150px;height: 150px" />
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/admin/service/saveservices.blade.php ENDPATH**/ ?>