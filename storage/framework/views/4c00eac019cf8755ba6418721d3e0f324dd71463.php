...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css?v=erftwet">
        ...
        <div class="card-actions flex justify-space-between">
            ...
            <div class="flex-end">
                ...
                <div id="razorpay_pay" class="payfrom">
                    ...
                    <form action="<?php echo route('razor-payment'); ?>" method="GET">
                        <?php if(Request::get('type') != 3): ?>
                            <input id="book_appointment_id" name="id" type="hidden" value="<?php echo e($data->id); ?>">
                            <?php else: ?>
                            <input id="amount" name="amount" type="hidden" value="<?php echo e(Request::get('amount')); ?>">
                        <?php endif; ?>
                        <input id="session_id" name="session_id" type="hidden" value="<?php echo e(Session::get('type')); ?>">
                        <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="<?php echo e($paymentdetail['razorpay_razorpay_key']); ?>"
                            data-amount="<?php echo e((int) $amount * 100); ?>" data-buttontext='<?php echo e(__('message.Pay')); ?>' data-name="<?php echo e(env('APP_NAME')); ?>"
                            data-description="Payment" data-image="<?php echo e(asset('public/image_web/896814.png')); ?>" data-prefill.name="name"
...
<?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/razorpay.blade.php ENDPATH**/ ?>