        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   ...
                   <form action="<?php echo e(url('updatemedicinefront1')); ?>" class="needs-validation" method="post" enctype="multipart/form-data">
                       ...
                       <div class="row">
                          ...
                          <div class="col-lg-12">
                             <div class="form-group">
                                <label for="name"><?php echo e(__("message.Name")); ?><span class="reqfield">*</span></label>
                                <input type="text" class="form-control" placeholder='<?php echo e(__("Enter Medicine Name")); ?>' id="edit_name" name="name" required="" value="">
                             </div>

                             <div class="form-group">
                                <label for="password"><?php echo e(__("message.Price")); ?><span class="reqfield">*</span></label>
                                <input type="number" class="form-control" id="edit_Price" placeholder='<?php echo e(__("Enter Medicine Price")); ?>' name="price" required="" value="">
                             </div>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/pharmacy/addmedicine.blade.php ENDPATH**/ ?>