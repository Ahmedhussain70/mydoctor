<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.Laboratory Details')); ?>
...
<?php $__env->startSection('content'); ?>
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1><?php echo e(__('message.Laboratory Details')); ?></h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <div class="auto-container">
                <ul class="bread-crumb clearfix">
                    ...
                    <li><?php echo e(__('message.Laboratory Details')); ?></li>
                </ul>
            </div>
        </div>
    </section>
                                            ...
                                            <ul class="info clearfix">
                                                ...
                                                <li style="text-align: center;">
                                                    ...
                                                    <?php if(Session::has('user_id') && Session::get('role_id') == '1'): ?>
                                                        <a href="#" class="theme-btn-one" data-toggle="modal"
                                                            data-target="#addprescription"
                                                            style="padding: 12px 30px;margin-left: 140px;"><?php echo e(__('message.Upload Prescription')); ?></a>
                                                    <?php else: ?>
                                                        <a href="#" class="theme-btn-one" onclick="pleaselogin()"
                                                            style="padding: 12px 30px;margin-left: 140px;"><?php echo e(__('message.Upload Prescription')); ?></a>
                                                    <?php endif; ?>
                                                </li>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">
                                                <?php echo e(__('message.Add Prescription')); ?></h5>
                                        ...
                                        <div class="modal-body">
                                            <div>
                                                <form action="<?php echo e(url('upload_pre_order')); ?>" method="post"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="phone_no" id="phone_no1"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="address" id="address1"
                                                            placeholder="<?php echo e(__('message.Enter')); ?> <?php echo e(__('message.Address')); ?>"
                                                            required="">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="btn-box" id="btnappointment">
                                                        <button class="theme-btn-one" type="submit"
                                                            style="box-shadow:none;"><?php echo e(__('message.submit')); ?></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <div class="tabs-box">
                                <div class="tab-btn-box centred">
                                    <ul class="tab-btns tab-buttons clearfix">
                                        <li class="tab-btn active-btn" data-tab="#tab-3"><?php echo e(__('message.Report')); ?></li>
                                ...
                                <div class="tabs-content">
                                    ...
                                    <div class="tab  active-tab" id="tab-3">
                                        <div class="location-box">
                                            <h3><?php echo e(__('message.Report')); ?></h3>
                                                        ...
                                                        <div class="clinic-block-one mb-3"
                                                            ...
                                                            <div class="inner-box"
                                                                ...
                                                                <figure class="image-box" style="height: 10px;top: 20px;">
                                                                    <img src="<?php echo e(asset('public/upload/laboratoryreport') . '/' . $dl->image); ?>"
                                                                ...
                                                                <div class="content-box">
                                                                    ...
                                                                    <span
                                                                        class="designation"><?php echo e(isset($dl->description) ? $dl->description : ''); ?></span>

                                                                    <div class="location-box" style="margin-top: 10px;">
                                                                        <?php $currency = explode('-', $setting->currency); ?>
                                                                        <p><b><?php echo e($dl->price); ?> <?php echo e($currency[1]); ?></b>
                                                                        </p>
                                                                    </div>
                                                                    <div class="btn-box" style=" bottom: 25px;">
                                                                        <?php if(Session::has('user_id') && Session::get('role_id') == '1'): ?>
                                                                            <a href="<?php echo e(url('addCart/' . $dl->id)); ?>"
                                                                                class="theme-btn-one"><?php echo e(__('message.Add Cart')); ?></a>
                                                                        <?php else: ?>
                                                                            <a href="#" class="theme-btn-one"
                                                                                onclick="pleaselogin()"><?php echo e(__('message.Add Cart')); ?></a>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <?php if(session()->get('cart') != null): ?>
                                                ...
                                                <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-12" style="border-bottom:1px solid #e5e7ec;">
                                                        <p><b><?php echo e($item['name']); ?></b> <a style="float: right;"
                                                                href="<?php echo e(url('removeCartItem/' . $item['id'])); ?>"><i
                                                                    style="color: red;" class="far fa-trash"></i></a></p>
                                                        <div class="row">
                                                            <div class="col-4 pb-2">
                                                                <p><?php echo e(__('message.Price')); ?>:
                                                                    <?php echo e($item['price']); ?><?php echo e($currency[1]); ?></p>
                                                            </div>
                                                            <div class="col-4">
                                                                <p><?php echo e(__('message.Qty')); ?>: <?php echo e($item['quantity']); ?></p>
                                                            </div>
                                                            <div class="col-4" style="display: inline;">
                                                                <p><?php echo e(__('message.Total')); ?>:
                                                                    <?php echo e($item['price'] * $item['quantity']); ?><?php echo e($currency[1]); ?>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4" style="text-align: right;">
                                                            <p> <?php echo e($setting->pharmacy_delivery_charge); ?><?php echo e($currency[1]); ?>
    ...
    <?php if(session()->get('cart') != null): ?>
        <div class="choose-service">
            ...
            <div class="form-group">
                <label><?php echo e(__('message.Address')); ?></label>
                <input type="text" name="address" id="address" placeholder="<?php echo e(__('Enter Your address')); ?>"
                    required="">
            </div>
            <div class="form-group">
                <label><?php echo e(__('message.Message')); ?></label>
                ...
                <?php if(Session::has('user_id') && Session::get('role_id') == '1'): ?>
                    ...
                    <?php else: ?>
                        <button type="button" class="theme-btn-one" onclick="alert('your cart is emty')"
                            id="show_book"><?php echo e(__('message.place order')); ?><i class="icon-Arrow-Right"></i></button>
                    <?php endif; ?>
                <?php else: ?>
            ...
            <div id="braintree_div" style="display:none;">
                <form action="<?php echo e(url('addlaboratoryorder')); ?>" method="post" id="payment-form">
                    <?php echo e(csrf_field()); ?>

                    <input type="hidden" name="laboratory_id" id="laboratory_id" value="<?php echo e($data->id); ?>">
            ...
            <div id="stripe_div" style="display:none;">
                <form action="<?php echo e(url('addlaboratoryorder')); ?>" method="post" id="stripe-form">
                    <?php echo e(csrf_field()); ?>
                    ...
                    <?php if(Session::has('user_id') && Session::get('role_id') == '1'): ?>
                        <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="<?php echo e(env('STRIPE_KEY')); ?>"
                            data-amount="<?php echo e($subtotal * 100); ?>" data-id="stripid" data-name="<?php echo e(__('message.System Name')); ?>"
            ...
            <div id="paytm_div" style="display:none;">
                <form action="<?php echo e(url('addlaboratoryorder')); ?>" method="post" id="payment-form">
                    ...
                    <input type="hidden" name="labratory_id" id="laboratory_id" value="<?php echo e($data->id); ?>">
                    <input type="hidden" name="total" value="<?php echo e($subtotal); ?>">
                    <input type="hidden" name="tax" value="<?php echo e($subtotal2); ?>">
                    <input type="hidden" name="delivery_charge" value="<?php echo e($setting->pharmacy_delivery_charge); ?>">
                ...
                <form action="<?php echo e(url('addlaboratoryorder')); ?>" method="post" id="payment-form">
                    ...
                    <?php if(Session::has('user_id') && Session::get('role_id') == '1'): ?>
                        <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="<?php echo e($paymentdetail['razorpay_razorpay_key']); ?>"
                            data-amount="<?php echo e((int) $subtotal * 100); ?>" data-buttontext='<?php echo e(__('message.Pay')); ?>'
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/viewlaboratory.blade.php ENDPATH**/ ?>