                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('backend/languages/en')); ?>"
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('backend/languages/ar')); ?>"
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('backend/languages/fr')); ?>"
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('backend/languages/es')); ?>"
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('backend/languages/pt')); ?>"
