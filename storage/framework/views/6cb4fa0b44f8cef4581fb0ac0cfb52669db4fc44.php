                           ...
                           <div class="inner-box">
                              <figure class="image-box">
                                 <?php if($uf->patientls->profile_pic!=""): ?>
                                       <img src="<?php echo e(asset('public/upload/profile').'/'.$uf->patientls->profile_pic); ?>" alt="">
                                 <?php else: ?>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/doctor/review.blade.php ENDPATH**/ ?>