        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div>
                            <h4 class="card-title float-left"><?php echo e(__('message.Laboratory Order')); ?> <?php echo e(__('message.List')); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($bdata->status == '0') {
                                                        ...
                                                        echo '<span class="status">' . __('message.Reject') . '</span>';
                                                    }
                                                    ?>
                                                </td>
        ...
        function get_reportdata(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#m_data").append("<p style='text-align: " + (isRTL ? "right" : "left") + ";'><b>" +
                        "<?php echo e(__('message.Laboratory')); ?> <?php echo e(__('message.Name')); ?>" + ": </b>" + orderDetails
                        .laboratory_id + "</p><hr>");
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/admin/laboratry/laboratoryorder.blade.php ENDPATH**/ ?>