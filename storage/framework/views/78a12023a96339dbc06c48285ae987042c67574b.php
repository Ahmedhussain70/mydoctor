...
<?php echo e(__('message.Laboratory Reviews')); ?>
...
<section class="page-title-two">
   <div class="title-box centred bg-color-2">
      ...
      <div class="auto-container">
         <div class="title">
            <h1><?php echo e(__('message.Laboratory Reviews')); ?></h1>
         </div>
      </div>
   </div>
   <div class="lower-content">
      <ul class="bread-crumb clearfix">
         ...
         <li><?php echo e(__('message.Laboratory Reviews')); ?></li>
      </ul>
   </div>
</section>
      ...
      <div class="profile-box">
         ...
         <div class="profile-info">
            <ul class="list clearfix">
                ...
                <li><a href="<?php echo e(url('laboratoryreview')); ?>" class="current"><i class="fas fa-star"></i><?php echo e(__('message.Reviews')); ?></a></li>
                <li><a href="<?php echo e(url('laboratoryeditprofile')); ?>"><i class="fas fa-user"></i><?php echo e(__('message.My Profile')); ?></a></li>
                           ...
                           <div class="inner-box">
                              <figure class="image-box">
                                 <?php if($uf->patientls->profile_pic!=""): ?>
                                       <img src="<?php echo e(asset('public/upload/profile').'/'.$uf->patientls->profile_pic); ?>" alt=""  style="max-height: 300px; min-height: 300px;">
                                 <?php else: ?>
                                        <img src="<?php echo e(asset('public/upload/profile/profile.png')); ?>" alt=""  style="max-height: 300px; min-height: 300px;">
                                 <?php endif; ?>
                              </figure>
                              <div class="lower-content">
                                 <ul class="name-box clearfix">
                                    <li class="name">
                                       <h3><a href="<?php echo e(url('viewlaboratory').'/'.$uf->doc_id); ?>"><?php echo e(substr($uf->patientls->name,0,10)); ?></a></h3>
                                    </li>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/laboratory/review.blade.php ENDPATH**/ ?>