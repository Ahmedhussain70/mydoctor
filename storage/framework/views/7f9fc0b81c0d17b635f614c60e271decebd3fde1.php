      ...
      <div class="profile-box">
         ...
         <div class="profile-info">
            <ul class="list clearfix">
                <li><a href="<?php echo e(url('laboratorydashboard')); ?>" ><i class="fas fa-columns"></i><?php echo e(__('message.Dashboard')); ?></a></li>
                <li><a href="<?php echo e(url('laboratoryreport')); ?>"><i class="fas fa-pills"></i><?php echo e(__('message.Reports')); ?></a></li>
                <li><a href="<?php echo e(url('laboratoryreview')); ?>" ><i class="fas fa-star"></i><?php echo e(__('message.Reviews')); ?></a></li>
                <li><a href="<?php echo e(url('laboratoryeditprofile')); ?>" class="current"><i class="fas fa-user"></i><?php echo e(__('message.My Profile')); ?></a></li>
                <li><a href="<?php echo e(url('laboratorychangepassword')); ?>"><i class="fas fa-unlock-alt"></i><?php echo e(__('message.Change Password')); ?></a></li>
            ...
            <div class="add-listing my-profile">
               <div class="single-box">
                  ...
                  <div class="inner-box">
                     ...
                     <?php endif; ?>
                     <form action="<?php echo e(url('updatelaboratory')); ?>" method="post" enctype="multipart/form-data">
                       <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="profile-title">
                                        <figure class="image-box">
                                          ...
                                          <?php if($doctordata->image!=""): ?>
                                             <img src="<?php echo e(asset('public/upload/doctors').'/'.$doctordata->image); ?>" alt="" accept="image/*">
                                          <?php else: ?>
                                             <img src="<?php echo e(asset('public/upload/doctors/defaultlaboratory.png')); ?>" alt="" >
                                          <?php endif; ?>
                                       </figure>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                ...
                                                <input type="text" name="name" id="name" placeholder="<?php echo e(__('message.Enter Laboratory Name')); ?>" required="" value="<?php echo e(isset($doctordata->name)?$doctordata->name:''); ?>">
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                ...
                                                <input type="text" name="working_time" placeholder="<?php echo e(__('message.Enter Working Time')); ?>" required="" id="working_time" value="<?php echo e(isset($doctordata->working_time)?$doctordata->working_time:''); ?>">
                                            </div>


                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                <label><?php echo e(__('message.About Us')); ?></label>
                                                <textarea name="aboutus" id="aboutus" placeholder="<?php echo e(__('message.Enter About Laboratory')); ?>" required=""><?php echo e(isset($doctordata->aboutus)?$doctordata->aboutus:''); ?></textarea>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                <label><?php echo e(__('message.Services')); ?></label>
                                                <textarea name="services"  id
                                                ="services" placeholder="<?php echo e(__('message.Enter Description about Services')); ?>" required=""><?php echo e(isset($doctordata->services)?$doctordata->services:''); ?></textarea>
                                            </div>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/laboratory/editprofile.blade.php ENDPATH**/ ?>