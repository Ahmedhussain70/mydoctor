                ...
                <div class="card">
                    <div class="card-body">
                        <div>
                            ...
                            <p><a href="<?php echo e(url('backend/addpharmacy/0')); ?>" type="button" class="btn btn-primary waves-effect waves-light mb-3 float-right"><?php echo e(__("message.Add")); ?> <?php echo e(__("message.Pharmacy")); ?></a></p>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/admin/pharmacy/pharmacy.blade.php ENDPATH**/ ?>