...
<?php echo e(__("message.Privecy")); ?> | <?php echo e(__("message.Admin Dashboard")); ?>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php endif; ?>
              <h4><?php echo e(__("message.Privecy")); ?></h4>
                        ...
                        <div class="modal-content">
                          <div class="row m-3">
                            ...
                            <div class="col-md-12 col-lg-4 col-xl-1">
                                <a href= "<?php echo e(url('Privacy-Policy')); ?>" class="btn btn-md btn-primary"
                                    value="Visit" target="#"><?php echo e(__('message.Visit')); ?></a>
                            </div>
                        </div>
                          <div class="modal-body">
                            <form action="<?php echo e(url('backend/edit_app_privacy')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/admin/privecy-app.blade.php ENDPATH**/ ?>