                ...
                <div class="row align-items-center clearfix">
                        ...
                        <div class="content_block_1">
                            <div class="content-box mr-50">
                                <div class="sec-title">
                                    ...
                                    <h2><?php echo e(__('message.Bring care to your home with one click')); ?></h2>
                                </div>
                                <!--<div class="text">-->
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_3">
                            <div class="image-box">
                                <div class="pattern">
                                    <div class="pattern-1" style="background-image: url('<?php echo e(asset('public/front_pro/assets/images/shape/shape-49.png')); ?>');"></div>
                                    <div class="pattern-2" style="background-image: url('<?php echo e(asset('public/front_pro/assets/images/shape/shape-50.png')); ?>');"></div>
                                    <div class="pattern-3"></div>
                                </div>
                                <figure class="image image-1 paroller"><img src="<?php echo e(asset('public/image_web').'/'.$setting->about_img_1); ?>" alt=""></figure>
                                <figure class="image image-2 paroller-2"><img src="<?php echo e(asset('public/image_web').'/'.$setting->about_img_2); ?>" alt=""></figure>
                                <div class="image-content">
                                    <figure class="icon-box"><img src="<?php echo e(asset('public/front_pro/assets/images/icons/icon-8.png')); ?>" alt=""></figure>
                                    <span><?php echo e(__('message.Appointment With')); ?></span>
                                    <h4><?php echo e(__('message.Specialist')); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content_block_5">
                            <div class="content-box">
                                <div class="sec-title">
                                    <p><?php echo e(__('message.Faq’s')); ?></p>
                                    <h2><?php echo e(__('message.Frequently Asked Questions.')); ?></h2>
                                </div>
                                <ul class="accordion-box">
                                    <li class="accordion block">
                                        <div class="acc-btn">
                                            <div class="icon-outer"></div>
                                            <h4><?php echo e(__('message.How do I contact customer service?')); ?></h4>
                                        </div>
                                        <div class="acc-content">
                                            <div class="text">
                                                <p><?php echo e(__('message.Ans1')); ?></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="accordion block active-block">
                                        <div class="acc-btn active">
                                            <div class="icon-outer"></div>
                                            <h4><?php echo e(__('message.Do doctors pay for good reviews?')); ?></h4>
                                        </div>
                                        <div class="acc-content current">
                                            <div class="text">
                                                <p><?php echo e(__('message.Ans2')); ?></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="accordion block">
                                         <div class="acc-btn">
                                            <div class="icon-outer"></div>
                                            <h4><?php echo e(__('message.Why didn t my review get posted?')); ?></h4>
                                        </div>
                                        <div class="acc-content">
                                            <div class="text">
                                                <p><?php echo e(__('message.Ans3')); ?></p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
