...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.Laboratory')); ?> <?php echo e(__('message.Report')); ?>
...
<?php $__env->startSection('content'); ?>
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1><?php echo e(__('message.Laboratory')); ?> <?php echo e(__('message.Report')); ?></h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <ul class="bread-crumb clearfix">
                ...
                <li><?php echo e(__('message.Laboratory')); ?> <?php echo e(__('message.Report')); ?></li>
            </ul>
        </div>
    </section>
    <section class="doctors-dashboard bg-color-3">
            ...
            <div class="profile-box">
                ...
                <div class="profile-info">
                    <ul class="list clearfix">
                        <li><a href="<?php echo e(url('laboratorydashboard')); ?>" ><i
                                    class="fas fa-columns"></i><?php echo e(__('message.Dashboard')); ?></a></li>
                        <li><a href="<?php echo e(url('laboratoryreport')); ?>" class="current"><i
                ...
                <div class="outer-container">
                    ...
                    <div class="doctors-appointment">
                        <div class="title-box">
                            ...
                            <div class="btn-box">
                                <button type="button" class="btn theme-btn-one" data-toggle="modal" data-target="#addreport">  <?php echo e(__('message.Add Report')); ?></button>
                            </div>
                        </div>
                                ...
                                <table id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="<?php echo e(asset('public/upload/laboratoryreport/'.$data->image)); ?>" width="100px;" alt="">
                                            </td>
                                            <td><?php echo e($data->name); ?></td>
                                            <td><?php echo e($data->description); ?></td>
                                            <td><?php echo e($data->price); ?></td>
                                            <td>
                                                <a href="#"  onclick="getdata(<?php echo e($data->id); ?>)" data-toggle="modal" data-target="#addreport" class="px-3 text-primary"><i class="fas fa-pen font-size-18"></i></a>

                                                <a href="<?php echo e(route('reportdeletefront',$data->id)); ?>" class="px-3 px-3 text-danger"><i class="fas fa-trash-alt font-size-18">
                                                        </i></a>
                                            </td>
                                        </tr>
         ...
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__("message.Add Report")); ?></h5>
                 ...
                 <div class="modal-body">
                    ...
                    <form action="<?php echo e(url('updatereportfront')); ?>" class="needs-validation" method="post" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>

                        <input type="hidden" name="laboratory_id" id="laboratory_id" value="<?php echo e(Session::get("user_id")); ?>">
                        <input type="hidden" name="order_id" id="order_id" value="0">
                        <div class="row">
                           <div class="col-lg-12">
                              <div class="form-group">
                                <label for="name"><?php echo e(__("message.Image")); ?><span class="reqfield">*</span></label>
                           ...
                           <div class="col-lg-12">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" placeholder='<?php echo e(__("message.Enter")); ?> <?php echo e(__("message.Report")); ?> <?php echo e(__("message.Name")); ?>' id="name" name="name" required="" value="">
                              </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="editreport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                          ...
                          <div class="col-lg-12">
                             <div class="form-group">
                               <label for="name"><?php echo e(__("message.Image")); ?><span class="reqfield">*</span></label>
                                   ...
                                   <input type="file" name="upload_image" id="upload_image" class="form-control" />
                                    <div id="img" class="mt-2"></div>
                             </div>
                          </div>
                          <div class="col-lg-12">
                             <div class="form-group">
                                <label for="name"><?php echo e(__("message.Name")); ?><span class="reqfield">*</span></label>
                                <input type="text" class="form-control" placeholder='<?php echo e(__("Enter Report Name")); ?>' id="edit_name" name="name" required="" value="">
                             </div>

                             <div class="form-group">
                                <label for="password"><?php echo e(__("message.Price")); ?><span class="reqfield">*</span></label>
                                <input type="number" class="form-control" id="edit_Price" placeholder='<?php echo e(__("Enter Report Price")); ?>' name="price" required="" value="">
                             </div>

                             <div class="form-group">
                               <label for="description"><?php echo e(__("message.description")); ?><span class="reqfield">*</span></label>
                               <textarea id="edit_description" class="form-control" rows="5" placeholder='<?php echo e(__("Enter Description")); ?>' name="description" required=""></textarea>
                            </div>
                          </div>
        ...
        <script>
            ...
            function getdata(id){
                $("#img").empty();
                $.ajax({
                url: $("#path_admin").val()+"/getdatalaboratory/"+id,
                data:{},
                success: function( data ) {
                    ...
                    if(data.image){
                        $("#img").append("<img class='m-2' src='" + $("#path_admin").val() + "/public/upload/laboratoryreport/" + data.image + "' style='width: 100px;'><a href='#' onclick='deleteimg(" + id + ")' style='color: red;'> <?php echo e(__('message.delete')); ?></a>");
                    }
            ...
            function deleteimg(id){
                $.ajax({
                url: $("#path_admin").val()+"/deleteimglaboratory/"+id,
                data:{},
                success: function( data ) {
                    // console.log(data);
                    if(data == 1){
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/laboratory/reports.blade.php ENDPATH**/ ?>