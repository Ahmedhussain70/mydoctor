...
<?php echo e(__('message.Pharmacy Reviews')); ?>
...
<section class="page-title-two">
   <div class="title-box centred bg-color-2">
      ...
      <div class="auto-container">
         <div class="title">
            <h1><?php echo e(__('message.Pharmacy Reviews')); ?></h1>
         </div>
      </div>
   </div>
   <div class="lower-content">
      <ul class="bread-crumb clearfix">
         ...
         <li><?php echo e(__('message.Pharmacy Reviews')); ?></li>
      </ul>
   </div>
</section>
      ...
      <div class="profile-box">
         ...
         <div class="profile-info">
            <ul class="list clearfix">
                ...
                <li><a href="<?php echo e(url('pharmacyreview')); ?>" class="current"><i class="fas fa-star"></i><?php echo e(__('message.Reviews')); ?></a></li>
                <li><a href="<?php echo e(url('pharmacyeditprofile')); ?>"><i class="fas fa-user"></i><?php echo e(__('message.My Profile')); ?></a></li>
                           ...
                           <div class="inner-box">
                              ...
                              <div class="lower-content">
                                 <ul class="name-box clearfix">
                                    <li class="name">
                                       <h3><a href="<?php echo e(url('viewpharmacy').'/'.$uf->doc_id); ?>"><?php echo e(substr($uf->patientls->name,0,10)); ?></a></h3>
                                    </li>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/pharmacy/review.blade.php ENDPATH**/ ?>