            ...
            <div class="profile-box">
                ...
                <div class="profile-info">
                    <ul class="list clearfix">
                        ...
                        <li><a href="<?php echo e(url('doctoreditprofile')); ?>" class="current"><i
                                    class="fas fa-user"></i><?php echo e(__('message.My Profile')); ?></a></li>
                                    <li><a href="<?php echo e(url('earningreports')); ?>" ><i class="fas fa-calendar-alt"></i><?php echo e(__('message.Earning Reports')); ?></a></li>
                                ...
                                <form action="<?php echo e(url('updatedoctor')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="profile-title">
                                        <figure class="image-box">
                                            ...
                                            <?php if($doctordata->image != ''): ?>
                                                <img src="<?php echo e(asset('public/upload/doctors') . '/' . $doctordata->image); ?>"
                                                    alt="" accept="image/*">
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('public/front_pro/assets/images/resource/profile-2.png')); ?>"
                                                    alt="">
                                            <?php endif; ?>
                                        </figure>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            ...
                                            <input type="text" name="name" id="name"
                                                placeholder="<?php echo e(__('message.Enter Doctor Name')); ?>" required=""
                                                value="<?php echo e(isset($doctordata->name) ? $doctordata->name : ''); ?>">
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            <div class="seldoctor">
                                                ...
                                                <select name="department_id" id="department_id">
                                                    ...
                                                    <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($dp->id); ?>"
                                                            <?= isset($doctordata->department_id) && $dp->id == $doctordata->department_id ? 'selected="selected"' : '' ?>>
                                                            <?php echo e($dp->name); ?></option>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            ...
                                            <input type="email" name="email"
                                                ...
                                                id="email"
                                                value="<?php echo e(isset($doctordata->email) ? $doctordata->email : ''); ?>">
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            <label><?php echo e(__('message.Phone no')); ?></label>
                                            <input type="text" name="phoneno" id="phoneno"
                                                placeholder="<?php echo e(__('message.Enter Phone No')); ?>" required=""
                                                value="<?php echo e(isset($doctordata->phoneno) ? $doctordata->phoneno : ''); ?>">
                                        </div>

                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            <label for="consultation_fees"><?php echo e(__('message.consultation_fees')); ?><span
                                                    class="reqfield">*</span></label>
                                            <input type="number" required name="consultation_fees"
                                                value="<?php echo e(isset($doctordata->consultation_fees) ? $doctordata->consultation_fees : ''); ?>"
                                                class="form-control" id="consultation_fees" min="1"
                                                step="0.01">
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            ...
                                            <input type="text" name="working_time"
                                                placeholder="<?php echo e(__('message.Enter Working Time')); ?>" required=""
                                                id="working_time"
                                                value="<?php echo e(isset($doctordata->working_time) ? $doctordata->working_time : ''); ?>">
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                            ...
                                            <textarea name="services" id
                                                ="services"
                                                placeholder="<?php echo e(__('message.Enter Description about Services')); ?>"><?php echo e(isset($doctordata->services) ? $doctordata->services : ''); ?></textarea>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                ...
                                                <select name="city_id" id="city_id">
                                                    ...
                                                    <?php $__currentLoopData = $city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($city->id); ?>"
                                                            <?= isset($doctordata->city_id) && $city->id == $doctordata->city_id ? 'selected="selected"' : '' ?>>
                                    ...
                                    <div class="col-md-12 p-0" id="addressorder">
                                        ...
                                        <input type="text" id="us2-address" name="address"
                                            placeholder='<?php echo e(__('message.Search Location')); ?>' required
                                    ...
                                    <input type="hidden" name="lat" id="us2-lat"
                                        value="<?php echo e(isset($doctordata->lat) ? $doctordata->lat : $setting->map_lat); ?>" />
                                    <input type="hidden" name="lon" id="us2-lon"
                                        value="<?php echo e(isset($doctordata->lon) ? $doctordata->lon : $setting->map_long); ?>" />

                            </div>

                        </div>
                        <div class="btn-box">
                            <button class="theme-btn-one" type="submit"><?php echo e(__('message.Save Change')); ?><i
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/doctor/editprofile.blade.php ENDPATH**/ ?>