...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.save')); ?> <?php echo e(__('message.Hospital')); ?> | <?php echo e(__('message.Admin')); ?> <?php echo e(__('message.Hospital')); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0"><?php echo e(__('message.save')); ?> <?php echo e(__('message.Hospital')); ?></h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(url('backend/hospital')); ?>"><?php echo e(__('message.Hospital')); ?></a>
                            </li>
                            <li class="breadcrumb-item active"><?php echo e(__('message.save')); ?> <?php echo e(__('message.Hospital')); ?></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-8 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(url('backend/updatehospital')); ?>" class="needs-validation" method="post"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder='<?php echo e(__('message.Enter Hospital Name')); ?>' id="name"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="aboutus" class="form-control" rows="5" name="aboutus"
                                            placeholder='<?php echo e(__('message.Enter About Hospital')); ?>' required=""><?php echo e(isset($data->aboutus) ? $data->aboutus : ''); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                 ...
                                 <!-- <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="home_visit"><?php echo e(__('message.Home Visit')); ?><span
                                                    class="reqfield"></span></label>
                                            <input type="text" class="form-control" id="home_visit" name="home_visit"
                                                placeholder="<?php echo e(__('message.Enter Home Visit Info')); ?>"
                                                value="<?php echo e(isset($data->home_visit) ? $data->home_visit : ''); ?>">
                                        </div>
                                    </div> -->

                                    <!-- <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="lab_visit"><?php echo e(__('message.Lab Visit')); ?></label>
                                            <input type="text" class="form-control" id="lab_visit" name="lab_visit"
                                                placeholder="<?php echo e(__('message.Enter Lab Visit Info')); ?>"
                                                value="<?php echo e(isset($data->lab_visit) ? $data->lab_visit : ''); ?>">
                                        </div>
                                    </div> -->
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-2">
                                    <div class="">
                                        ...
                                        <select name="city_id" id="city_id" class="form-control">
                                            <option value=""><?php echo e(__('message.select')); ?> <?php echo e(__('message.city')); ?></option>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-2">
                                    <div class="">
                                        <label><?php echo e(__('message.Department')); ?></label>
                                        <select name="department_id[]" id="department_id" class="form-control" multiple>
                                            <?php
                                                $selected_departments = isset($data->department_id) ? json_decode($data->department_id, true) : [];
                                            ?>
                                            <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($d->id); ?>" <?php echo e(in_array($d->id, $selected_departments) ? 'selected' : ''); ?>><?php echo e($d->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-2">
                                    <div class="">
                                        <label><?php echo e(__('message.Doctors')); ?></label>
                                        <select name="doctor_id[]" id="doctor_id" class="form-control" multiple>
                                            <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($doc->id); ?>" <?php echo e(in_array($doc->id, $assigned_doctors) ? 'selected' : ''); ?>><?php echo e($doc->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                               ...
                               <div class="form-group">
                                    ...
                                    <input type="text" id="address-input" name="address" class="form-control map-input" required value="<?php echo e(isset($data->address) ? $data->address : ''); ?>">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        if (typeof $ !== 'undefined' && $.fn.select2) {
            $('#city_id').select2({
                theme: 'bootstrap-5',
                width: '100%',
                placeholder: "<?php echo e(__('message.select')); ?> <?php echo e(__('message.city')); ?>"
            });
            $('#department_id').select2({
                theme: 'bootstrap-5',
                width: '100%',
                placeholder: "<?php echo e(__('message.select')); ?> <?php echo e(__('message.Department')); ?>"
            });
            $('#doctor_id').select2({
                theme: 'bootstrap-5',
                width: '100%',
                placeholder: "<?php echo e(__('message.select')); ?> <?php echo e(__('message.Doctors')); ?>"
            });
        } else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mydoctor\resources\views/admin/hospital/savehospital.blade.php ENDPATH**/ ?>