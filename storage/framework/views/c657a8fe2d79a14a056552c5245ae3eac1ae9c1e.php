      ...
      <div class="profile-box">
         ...
         <div class="profile-info">
            <ul class="list clearfix">
                <li><a href="<?php echo e(url('pharmacydashboard')); ?>" ><i class="fas fa-columns"></i><?php echo e(__('message.Dashboard')); ?></a></li>
                <li><a href="<?php echo e(url('pharmacymedicine')); ?>"><i class="fas fa-pills"></i><?php echo e(__('message.Medicine')); ?></a></li>
                <li><a href="<?php echo e(url('pharmacyreview')); ?>" ><i class="fas fa-star"></i><?php echo e(__('message.Reviews')); ?></a></li>
                <li><a href="<?php echo e(url('pharmacyeditprofile')); ?>" class="current"><i class="fas fa-user"></i><?php echo e(__('message.My Profile')); ?></a></li>
                <li><a href="<?php echo e(url('pharmacychangepassword')); ?>"><i class="fas fa-unlock-alt"></i><?php echo e(__('message.Change Password')); ?></a></li>
            ...
            <div class="add-listing my-profile">
               <div class="single-box">
                  ...
                  <div class="inner-box">
                     ...
                     <?php endif; ?>
                     <form action="<?php echo e(url('updatepharmacy')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="profile-title">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                ...
                                                <input type="text" name="name" id="name" placeholder="<?php echo e(__('message.Enter Pharmacy Name')); ?>" required="" value="<?php echo e(isset($doctordata->name)?$doctordata->name:''); ?>">
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                ...
                                                <textarea name="aboutus" id="aboutus" placeholder="<?php echo e(__('message.Enter About Pharmacy')); ?>" required=""><?php echo e(isset($doctordata->aboutus)?$doctordata->aboutus:''); ?></textarea>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/pharmacy/editprofile.blade.php ENDPATH**/ ?>