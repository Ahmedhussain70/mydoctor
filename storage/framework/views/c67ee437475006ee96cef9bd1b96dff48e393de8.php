                    ...
                    <div class="col-xl-6 col-lg-12 mb-4">
                        <div class="card h-100">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h4><?php echo e(__('message.Monthly_Appointment_Report')); ?></h4>
                            </div>
                            <div class="card-body">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>