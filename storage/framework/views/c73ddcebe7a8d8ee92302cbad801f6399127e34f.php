...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-6 category-block">
                        <div class="category-block-one wow fadeInUp animated animated animated" data-wow-delay="00ms"
                            ...
                            <div class="inner-box">
                                ...
                                <h3> <?php echo e($currency[1]); ?> <?php echo e($subscription->price); ?>/<?php echo e($subscription->month); ?> <?php echo e(__('message.month')); ?></h3>
                                <ul class="features">
                                    <li><i class="fas fa-check-circle"></i> <?php echo e(__('message.sub_plan_test_1')); ?></li>
                                    <li><i class="fas fa-check-circle"></i> <?php echo e(__('message.sub_plan_test_2')); ?></li>
                                    <li><i class="fas fa-check-circle"></i> <?php echo e(__('message.sub_plan_test_3')); ?></li>
                                </ul>
                                ...
                                <div class="btn-box"><a href="#" data-toggle="modal" data-target="#add_plan"
                                        ...
                                        class="theme-btn-one"><?php echo e(__('message.purchase plan')); ?><i class="icon-Arrow-Right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="row mx-1">
                        ...
                        <div class="col-6">
                            ...
                            <p><b><?php echo e($currency[1]); ?> </b><b id="pland"></b></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="choose-service">
                                ...
                                <div class="col-md-6">
                                    <div class="custom-check-box">
                                        <div class="custom-controls-stacked">
                                            <label class="custom-control material-checkbox">
                                                <input type="radio" class="material-control-input" name="payment_type"
                                                    id="payment_type_uploaded_receipt" value="8"
                                                    onchange="changeform(this.value)">
                                                <span class="material-control-indicator"></span>
                                                <span class="description"><?php echo e(__('message.Uploaded Receipt')); ?></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="uploaded_receipt_div" style="display: none;">
                                    <form action="<?php echo e(url('doctor_add_plan')); ?>" method="POST"
                                        enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>

                                        <input type="hidden" name="doctor_id" value="<?php echo e($doctor_id->id); ?>">
                                        <input type="hidden" name="payment_type" value="8">
                                        <!-- 8 = Uploaded Receipt -->
                                        <input type="hidden" name="plan_id" id="plan_id_uploaded" value="">
                                        <input type="hidden" name="amount" id="plan_price_uploaded" value="">
                                        ...
                                        <div class="form-group">
                                            <label>Receipt Description (optional)</label>
                                            <textarea name="receipt_description" class="form-control" placeholder="Write any note..."></textarea>
                                        </div>
    ...
    <script>
        ...
        function get_plan_id(id, price, month) {
            ...
            $("#pland").text( price + "/" + month + " <?php echo e(__('message.month')); ?>");
            ...
            $("#payment_type_uploaded_receipt").prop("checked", false);
        ...
        function changeform(val) {
            ...
            if ($("#payment_type_paystack").prop("checked") == true) {
             ...
             if ($("#payment_type_uploaded_receipt").prop("checked") == true) {
                $("#uploaded_receipt_div").css("display", "block");
                $("#braintree_div").css("display", "none");
                $("#stripe_div").css("display", "none");
                $("#rave_div").css("display", "none");
                $("#razorpay_div").css("display", "none");
                ...
                // set values to the hidden inputs in uploaded_receipt form
                $("#plan_id_uploaded").val(plan_id);
                $("#plan_price_uploaded").val(plan_price);
            }
            // } else {
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/doctor/subscription_plan.blade.php ENDPATH**/ ?>