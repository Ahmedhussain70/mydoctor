    ...
    <div class="container-fluid mb-4">
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(url('backend/Pharmacy')); ?>"><?php echo e(__('message.Pharmacy')); ?></a>
                            </li>
        ...
        <div class="row" style="display: flex;justify-content: center;">
            <div class="col-xl-8 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo e(url('backend/updatepharmacy')); ?>" class="needs-validation" method="POST"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/admin/pharmacy/savepharmacy.blade.php ENDPATH**/ ?>