            ...
            <div class="col-xl-12 col-md-12">
               <div class="card">
                  <div class="card-body">
                     ...
                     <form action="<?php echo e(url('backend/updatenotificationkey')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\krupa\doctorlab\resources\views/admin/notificationkey.blade.php ENDPATH**/ ?>