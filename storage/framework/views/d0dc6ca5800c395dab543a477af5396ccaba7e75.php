<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.About Us')); ?> | <?php echo e(__('message.Admin Dashboard')); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <h4><?php echo e(__('message.About Us')); ?> </h4>
                                        ...
                                        <div class="modal-content">
                                            <div class="row m-3">
                                                ...
                                                <div class="col-md-12 col-lg-4 col-xl-1">
                                                    <a href= "<?php echo e(url('aboutus')); ?>" class="btn btn-md btn-primary"
                                                        value="Visit" target="#"><?php echo e(__('message.Visit')); ?></a>
                                                </div>
                                            </div>
                                            <div class="modal-body">
                                                <form action="<?php echo e(url('backend/edit_about')); ?>" method="post"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/admin/about.blade.php ENDPATH**/ ?>