<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.Laboratory Order')); ?>
    ...
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1><?php echo e(__('message.Laboratory Order')); ?></h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <ul class="bread-crumb clearfix">
                ...
                <li><?php echo e(__('message.Laboratory Order')); ?></li>
            </ul>
        </div>
    </section>
            ...
            <div class="profile-box patient-profile">
                ...
                <div class="profile-info">
                    <ul class="list clearfix">
                        ...
                        <li><a href="<?php echo e(url('userlabreportlist')); ?>" class="current"><i
            ...
            <div class="content-container">
                <div class="outer-container">
                    ...
                    <div class="doctors-appointment">
                        <div class="title-box">
                            <h3><?php echo e(__('message.Laboratory Order')); ?></h3>
                        </div>
                                ...
                                <table class="" id="myTable">
                                    <thead class="table-header">
                                        <tr>
                                            ...
                                            <th><?php echo e(__('message.Laboratory')); ?> <?php echo e(__('message.Name')); ?></th>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $orderdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <p><?php echo e($bdata->laboratory_id); ?></p>
                                                </td>
                                                ...
                                                <td>
                                                    <button onclick="get_reportdata(<?php echo $bdata->id; ?>)"
                                                ...
                                                <td>
                                                    <?php
                                                    if ($bdata->status == '0') {
                                                        echo '<span class="status">' . __('message.Process') . '</span>';
                                                        ...
                                                        echo '<span class="status">' . __('message.Sample Collected') . '</span>';
        ...
        <script>
            function get_reportdata(id) {
                ...
                $.ajax({
                    ...
                    url: $("#path_admin").val() + "/get_reportdata" + "/" + id,
                    data: {},
                    success: function(data) {
                        ...
                        $("#m_data").append("<p style='text-align: " + (isRTL ? "right" : "left") + ";'><b>" +
                            "<?php echo e(__('message.Laboratory')); ?> <?php echo e(__('message.Name')); ?>" + ": </b>" +
                            orderDetails
                            .laboratory_id + "</p><hr>");
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/patient/laboratoryreportlist.blade.php ENDPATH**/ ?>