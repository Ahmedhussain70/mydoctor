                                            ...
                                            <ul class="info clearfix">
                                                <li><i class="fas fa-map-marker-alt"></i><?php echo e(substr($data->address, 0, 40)); ?>
                                                    ...
                                                    <a href="https://maps.google.com/?q=<?php echo e($data->lat); ?>,<?php echo e($data->lon); ?>"
                                                        ...
                                                        <?php echo e(__('message.View Map')); ?></a></li>
                            ...
                            <div class="tabs-box">
                                <div class="tab-btn-box centred">
                                    <ul class="tab-btns tab-buttons clearfix">
                                        <li class="tab-btn active-btn" data-tab="#tab-3"><?php echo e(__('message.Medicine')); ?>
                                                            ...
                                                            <div class="inner-box"
                                                                ...
                                                                <div class="content-box">
                                                                    ...
                                                                    <div class="btn-box" style=" bottom: 25px;">
                                                                        <?php if(Session::has('user_id') && Session::get('role_id') == '1'): ?>
                                                                            <a href="<?php echo e(url('addToCart/' . $dl->id)); ?>"
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/viewpharmacy.blade.php ENDPATH**/ ?>