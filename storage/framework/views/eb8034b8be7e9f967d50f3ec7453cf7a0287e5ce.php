            ...
            <div class="profile-box patient-profile">
                ...
                <div class="profile-info">
                    <ul class="list clearfix">
                        <li><a href="<?php echo e(url('userdashboard')); ?>" class="current"><i
                                    class="fas fa-columns"></i><?php echo e(__('message.Dashboard')); ?></a></li>
                        <li><a href="<?php echo e(url('usermedicineorder')); ?>"><i
                                    class="fas fa-columns"></i><?php echo e(__('message.Medicine Order')); ?></a></li>
                        <li><a href="<?php echo e(url('userlabreportlist')); ?>"><i
                                    class="fas fa-columns"></i><?php echo e(__('message.Laboratory Report')); ?></a></li>
                ...
                <div class="outer-container">
                    ...
                    <?php if(Session::has('success') || Session::has('error')): ?>
                        <div class="col-sm-12">
                            ...
                            <?php echo e(Session::has('success') ? 'alert-success' : ''); ?>

                            <?php echo e(Session::has('error') ? 'alert-danger' : ''); ?>"
                                role="alert">

                                <?php echo e(Session::get('success') ?? Session::get('error')); ?>
                    ...
                    <div class="doctors-appointment">
                        <div class="title-box">
                            ...
                            <div class="btn-box">
                                <?php if($type == 2): ?>
                                    <a href="<?php echo e(url('userdashboard?type=2')); ?>"
                                        class="theme-btn-one"><?php echo e(__('message.past')); ?> <i
                                            class="icon-Arrow-Right"></i></a>
                                <?php else: ?>
                                    <a href="<?php echo e(url('userdashboard?type=2')); ?>"
                                        class="theme-btn-two"><?php echo e(__('message.past')); ?></a>
                                <?php endif; ?>
                                <?php if(!isset($type)): ?>
                                    <a href="<?php echo e(url('userdashboard')); ?>" class="theme-btn-one"><?php echo e(__('message.Today')); ?>

                                        <i class="icon-Arrow-Right"></i></a>
                                <?php else: ?>
                                    <a href="<?php echo e(url('userdashboard')); ?>"
                                        class="theme-btn-two"><?php echo e(__('message.Today')); ?></a>
                                <?php endif; ?>
                                <?php if($type == 3): ?>
                                    <a href="<?php echo e(url('userdashboard?type=3')); ?>"
                                        class="theme-btn-one"><?php echo e(__('message.Upcoming')); ?> <i
                                            class="icon-Arrow-Right"></i></a>
                                <?php else: ?>
                                    <a href="<?php echo e(url('userdashboard?type=3')); ?>"
                                        class="theme-btn-two"><?php echo e(__('message.Upcoming')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <div class="table-outer">
                                        ...
                                        <?php $__currentLoopData = $bookdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td data-toggle="modal" data-target="#queryModalgrid"
                                                    onclick="get_desc(<?php echo $bdata->id; ?>)">
                                                    <div class="name-box">
                                                        <figure class="image">
                                                            <?php if(isset($bdata->doctorls)): ?>
                                                                <img src="<?php echo e(asset('public/upload/doctors') . '/' . $bdata->doctorls->image); ?>"
                                                                    alt="">
                                                            <?php else: ?>
                                                        ...
                                                        <h5><?php echo e(isset($bdata->doctorls) ? $bdata->doctorls->name : ''); ?>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if($bdata->prescription_file != ''): ?>
                                                        <li><a href="<?php echo e(asset('public/upload/prescription') . '/' . $bdata->prescription_file); ?>"
                                                                target="_blank" class="btn btn-success"
                                                                style="color:white"><?php echo e(__('message.View Prescription')); ?></a>
                                                        </li>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php if($bdata->status == '2' || $bdata->status == '3' || $bdata->status == '1'): ?>
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="reject_record('<?php echo e($bdata->id); ?>')"><?php echo e(__('message.Reject')); ?></button>
                                                    <?php endif; ?>
                                                </td>
                                ...
                                <script>
                                    function reject_record(id) {
                                        if (confirm("do you want to reject this appointment?")) {
                                            window.location.href = "<?php echo e(route('rejectuserappointment', ':id')); ?>".replace(':id', id);
                                        }
                                    }
                                </script>
                                <?php echo e($bookdata->links('pagination::bootstrap-4')); ?>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class ="h6"><span id="status1"
                                            style="position: relative; display: inline-block;font-size: 13px;line-height: 16px; font-weight: 600;padding: 5px 15px; border-radius: 15px; background: #ebfbf3;color: #39dc86;">
                                        </span></div>
                                </div>
                                <div class="col-3">
                            ...
                            <div class="container-fluid">
                                <h4 class="modal-title mt-2">
                                    <?php echo e(__('message.Prescription')); ?>
                    ...
                    function get_desc(id) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $("#myImage").attr("src", "<?php echo e(asset('public/upload/doctors')); ?>/" + data.doctorls.image);
                                //   $("#status").html(data.status);

                                if (data.status === 1) {
                                    $("#status1").html("<?php echo e(__('message.Received')); ?>");
                                } else if (data.status === 2) {
                                    $("#status1").html("<?php echo e(__('message.Approved')); ?>");
                                } else if (data.status === 3) {
                                    $("#status1").html("<?php echo e(__('message.In Process')); ?>");
                                } else if (data.status === 4) {
                                    $("#status1").html("<?php echo e(__('message.Completed')); ?>");
                                } else if (data.status === 5) {
                                    $("#status1").html("<?php echo e(__('message.Rejected')); ?>");
                                } else {
                                    $("#status1").html("<?php echo e(__('message.Absent')); ?>");
                                }
                                ...
                                if (data.medicine) {
                                    ...
                                    for (var i = 0; i < medicines.length; i++) {
                                        ...
                                        $("#m_data").append(
                                            ...
                                            '</div>' +
                                            '<div class="row">' +
                                            '<div class="col- "><?php echo e(__('message.Type')); ?>:&nbsp;&nbsp;</div>' +
                                            '<div class="col-"><p class="text-dark" id="m_tablet">' + medicines[i]
                                            .type + '</p></div>' +
                                            '<div class="offset-2 col- "><?php echo e(__('message.Dosage')); ?>:&nbsp;&nbsp;</div>' +
                                            '<div class="col-"><p class="text-dark" id="m_dosage">' + medicines[i]
                                            .dosage + '</p></div>' +
                                            '<div class="offset-2 col- "><?php echo e(__('message.Time')); ?>:&nbsp;&nbsp;</div>' +
                                            '<div class="col-"><p class="text-dark" id="m_time">' + tTime +
                                            '</p></div>' +
                                            '</div>' +
                                            '<div class="row">' +
                                            '<div><?php echo e(__('message.Consume it for')); ?> ' + medicines[i].repeat_days +
                                            ' <?php echo e(__('message.Days')); ?></div>' +
                                            '</div>' +
                                            '</div>' +
                                            '<hr>'
                                        );
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\krupa\doctorlab\resources\views/user/patient/dashboard.blade.php ENDPATH**/ ?>