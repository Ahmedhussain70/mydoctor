<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.Doctor Subscription Report')); ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0"><?php echo e(__('message.Doctor Subscription Report')); ?></h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item active"><?php echo e(__('message.Doctor Subscription Report')); ?></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <h4 class="card-title">
                            <?php if(Request::get('data_filter')): ?>
                                <?php if($total == null): ?>
                                    <?php echo e(__('message.doctor subscribe not found')); ?>

                                <?php else: ?>
                                    <?php echo e(__('message.Total doctor subscribe are')); ?> <?php echo e($total); ?>
