            ...
            <div class="inner-box">
                <div class="content-box">
                    ...
                    <div class="inner">
                        ...
                        <form action="<?php echo e(isset($patient) ? url('user/update/' . $patient->id) : url('userpostregister')); ?>"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    ...
                                    <input type="text" id="name" name="name"
                                        placeholder="<?php echo e(__('message.Your name')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    ...
                                    <input type="text" name="phone" id="phone"
                                        placeholder="<?php echo e(__('message.Enter Your Phone number')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        ...
                                        <input type="password" name="password_confirmation" id="cpwd"
                                            onchange="checkbothpassword(this.value)"
                                            placeholder="<?php echo e(__('message.Enter Confirm password')); ?>" required />
                                        ...
                                        <div class="custom-check-box">
                                            <div class="custom-controls-stacked">
                                                <label class="custom-control ">
                                                    <input type="checkbox" class="material-control-input" name="agree"
                                                        value="1" required />
                                                    <span class="material-control-indicator"></span>
                                                    <span class="description">
                                                        <?php echo e(__('message.I accept')); ?>

                                                        <a href="<?php echo e(url('/')); ?>"><?php echo e(__('message.terms')); ?></a>
                                                        <?php echo e(__('message.and')); ?>

                                                        <a href="<?php echo e(url('/')); ?>"><?php echo e(__('message.conditions')); ?></a>
                                                        <?php echo e(__('message.and general policy')); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                    <button type="submit" class="theme-btn-one">
                                        <?php echo e(isset($patient) ? __('message.Update Profile') : __('message.Register Now')); ?>
                        ...
                        <div class="login-now">
                            <p><?php echo e(__('message.Already have an account')); ?> <a
                                    href="<?php echo e(url('patientlogin')); ?>"><?php echo e(__('message.Login Now')); ?></a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/patient/register.blade.php ENDPATH**/ ?>