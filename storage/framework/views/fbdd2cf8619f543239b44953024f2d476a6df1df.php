<?php $__env->startSection('title'); ?>
    <?php echo e(__('message.Pharmacy')); ?> <?php echo e(__('message.Dashboard')); ?>
    ...
    <section class="page-title-two">
        <div class="title-box centred bg-color-2">
            ...
            <div class="auto-container">
                <div class="title">
                    <h1><?php echo e(__('message.Pharmacy')); ?> <?php echo e(__('message.Dashboard')); ?></h1>
                </div>
            </div>
        </div>
        <div class="lower-content">
            <ul class="bread-crumb clearfix">
                ...
                <li><?php echo e(__('message.Pharmacy')); ?> <?php echo e(__('message.Dashboard')); ?></li>
            </ul>
        </div>
    </section>
    <section class="doctors-dashboard bg-color-3">
            ...
            <div class="profile-box">
                ...
                <div class="profile-info">
                    <ul class="list clearfix">
                        <li><a href="<?php echo e(url('pharmacydashboard')); ?>" class="current"><i
                                    class="fas fa-columns"></i><?php echo e(__('message.Dashboard')); ?></a></li>
                        <li><a href="<?php echo e(url('pharmacymedicine')); ?>"><i
                            ...
                            <div class="col-xl-4 col-lg-12 col-md-12 feature-block">
                                <div class="feature-block-two">
                                    <div class="inner-box">
                                        ...
                                        <h5><?php echo e(__('message.Total Order')); ?></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-12 col-md-12 feature-block">
                            ...
                            <div class="col-xl-4 col-lg-12 col-md-12 feature-block">
                                <div class="feature-block-two">
                                    <div class="inner-box">
                                        ...
                                        <h5><?php echo e(__('message.New Order')); ?></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $orderdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($bdata->user_name); ?> </td>
                                                ...
                                                <td>
                                                    <?php if($bdata->status == '0'): ?>
                                                        <a href="<?php echo e(url('pharmacyorderchangestatus/' . $bdata->id . '/' . '1')); ?>"
                                                            class="btn btn-success"><?php echo e(__('message.Accept')); ?></a>
                                                        <a href="<?php echo e(url('pharmacyorderchangestatus/' . $bdata->id . '/' . '2')); ?>"
                                                            class="btn btn-danger"><?php echo e(__('message.Reject')); ?></a>
                                                    <?php elseif($bdata->status == '4'): ?>
                                                        <a href="<?php echo e(url('pharmacyorderchangestatus/' . $bdata->id . '/' . '7')); ?>"
                                                            class="btn btn-primary"><?php echo e(__('message.Prepared')); ?></a>
                                                    <?php elseif($bdata->status == '1' && $bdata->order_type == '2'): ?>
                                                        <a href="<?php echo e(url('pharmacyorderchangestatus/' . $bdata->id . '/' . '7')); ?>"
                                                            class="btn btn-primary"><?php echo e(__('message.Prepared')); ?></a>
                                                    <?php elseif($bdata->status == '7'): ?>
                                                        <a href="<?php echo e(url('pharmacyorderchangestatus/' . $bdata->id . '/' . '8')); ?>"
                                                            class="btn btn-primary"><?php echo e(__('message.Out for Delivery')); ?></a>
                                                    <?php elseif($bdata->status == '8'): ?>
                                                        <a href="<?php echo e(url('pharmacyorderchangestatus/' . $bdata->id . '/' . '3')); ?>"
                                                            class="btn btn-success"><?php echo e(__('message.Completed')); ?></a>
                                                    <?php elseif($bdata->status == '1' && $bdata->order_type == '1'): ?>
                                                        <a href="<?php echo e(url('pharmacyorderchangestatus/' . $bdata->id . '/' . '1')); ?>"
                                                            onclick="addid(<?php echo e($bdata->id); ?>)" class="btn btn-warning"
                                                            style="color: white;" data-toggle="modal"
                                                            data-target="#addprice"><?php echo e(__('message.Add')); ?>

                                                            <?php echo e(__('message.Price')); ?></a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"> <?php echo e(__('message.Doctor Details')); ?></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/pharmacy/dashboard.blade.php ENDPATH**/ ?>